...
class ForgotPasswordController extends Controller
{
    ...
    public function reset_password_request(Request $request)
    {
        ...
        if ($verification_by == 'email') {
            ...
            if (isset($customer)) {
                ...
                Toastr::success(Helpers::translate('Check your email. Password reset url sent.'));
                return back();
            }
            ...
            if (isset($customer)) {
                ...
                $reset_url = url('/') . '/customer/auth/reset-password?token=' . $token;
                $user = $customer;
                $msg = Helpers::get_business_settings('sign_up_message')['message'];
                $msg = str_replace('{username}',$user->f_name,$msg);
                $msg = $msg.' '.$reset_url;
                Helpers::sendSms(Helpers::get_business_settings('msegat_sms')[''],$user->phone,$msg);
                Toastr::success(Helpers::translate('Check your phone. Password reset otp sent.'));
                return back();
            }
        }
    ...
    public function reset_password_submit(Request $request)
    {
        ...
        if (isset($data)) {
            ...
            Toastr::success(Helpers::translate('Password reset successfully.'));
