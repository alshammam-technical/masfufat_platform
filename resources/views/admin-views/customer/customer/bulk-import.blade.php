...
<html>
  <head>
    <title>{{ Helpers::translate('Import stores') }}</title>
    <meta charset="UTF-8" />
    ...
    <script>
        ...
        const columns = [
            ...
            },
            {
                ...
                "name": "{{Helpers::translate('Store Account number')}}",
                "size": 300,
            },
            {
                "prop": "company_name",
            ...
            },
            {
                ...
                "name": "{{Helpers::translate('commercial_registration_no')}}",
                "size": 300,
            },
            {
                "prop": "tax_no",
                "name": "{{Helpers::translate('tax number')}}",
                "size": 300,
            },
            {
                "prop": "pricing_level",
                "name": "{{Helpers::translate('pricing level')}}",
                "size": 300,
                "single": 1,
                "editor": 'select',
            ...
            },
            {
                ...
                "single": 1,
                "editor": 'select',
                "editorSource": {!! Helpers::getGovernoratesOptions() !!},
            },
            {
                "prop": "address",
            ...
            {
                "prop": "site_url",
                "name": "{{Helpers::translate('Store url')}}",
                "size": 300,
                "editor": "textarea",
            },
            {
                "prop": "Store account manager",
                "name": "{{Helpers::translate('manager_id')}}",
                "size": 300,
                "editor": 'select',
                "editorSource": {!! Helpers::getadminsOptions() !!},
            },

            {
                "prop": "image[]",
                "name": "{{Helpers::translate('Store Image')}}",
                "editor": "img",
                "size": 300
            },
            {
                "prop": "imageUrl",
                "name": "{{Helpers::translate('Store Image')}} ({{ Helpers::translate('Url') }})",
                "size": 300
            },

            {
                "prop": "commercial_registration_img[]",
                "name": "{{Helpers::translate('commercials_registrations_image')}}",
                "editor": "file",
                "size": 300
            },
            {
                "prop": "commercial_registration_imgUrl",
                "name": "{{Helpers::translate('commercials_registrations_image')}} ({{ Helpers::translate('Url') }})",
                "size": 300
            },

            {
                "prop": "tax_certificate_img[]",
                "name": "{{Helpers::translate('shop_tax_certificates_image')}}",
                "editor": "file",
                "size": 300
            },
            {
                "prop": "tax_certificate_imgUrl",
                "name": "{{Helpers::translate('shop_tax_certificates_image')}} ({{ Helpers::translate('Url') }})",
                "size": 300
            },
        ...
        async function save(){
            ...
            for (let key = current; key <= (parseInt(source_length) + 1); key++) {
                ...
                if(item['vendor_account_number']){
                    ...
                    await $.ajax({
                        url: "{{ route('admin.stores.bulk-import-ii') }}",
                        type: 'post',
                        data: formData[key],
                        dataType: 'json',
                        contentType: false,
                        ...
                        success: function(data){
                            if(data.errors){
                                ...
                                if(row == source_length){
                                    location.replace("{{route('admin.stores.list')}}")
                                }
                            }
                        },
                        error: function(){
