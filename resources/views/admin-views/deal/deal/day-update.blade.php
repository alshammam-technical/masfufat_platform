...
@section('title', \App\CPU\Helpers::translate('Deal Update'))
@push('css_or_js')
...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            ...
            {{\App\CPU\Helpers::translate('Update Deal of The Day')}}
        </h2>
    </div>
    <!-- End Page Title -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12 mt-3">
                                    <label for="name" class="title-color">{{ \App\CPU\Helpers::translate('product')}}</label>
                                    <select
