...
@section('title', \App\CPU\Helpers::translate('Flash Deal Update'))
@push('css_or_js')
...
<div class="content container-fluid">
    ...
    <div class="mb-3">
        <h2 class="h1 mb-0 text-capitalize d-flex gap-2">
            ...
            {{\App\CPU\Helpers::translate('flash_deals_update')}}
        </h2>
    </div>
    <!-- End Page Title -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.deal.update',[$deal['id']])}}" method="post" style="text-align: {{(Session::get('direction') ?? 'rtl') === "rtl" ? 'right' : 'left'}};" enctype="multipart/form-data">
                        @csrf
                        @php
                        ...
                        <div class="form-group">
                            @foreach(Helpers::get_langs() as $lang)
                                ...
                                <div class="row {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                    ...
                                    <div class="col-md-12">
                                        <label for="name" class="title-color">{{ \App\CPU\Helpers::translate('Title')}} ({{strtoupper($lang)}})</label>
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-3">
                                    <label for="name" class="title-color">{{ \App\CPU\Helpers::translate('start_date')}}</label>
                                    <input type="date" value="{{date('Y-m-d',strtotime($deal['start_date']))}}" name="start_date" required
                                           class="form-control">
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label for="name" class="title-color">{{ \App\CPU\Helpers::translate('end_date')}}</label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 pt-3">
                                    ...
                                    <span class="text-info ml-0">( {{\App\CPU\Helpers::translate('ratio')}} 5:1 )</span>
