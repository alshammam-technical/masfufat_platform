        ...
        <div >
            <a href="{{route('about-us')}}">
                ...
                <div style="text-align: center;">
                        ...
                        <p>
                            {{ \App\CPU\Helpers::translate('About Company')}}
                        </p>
        ...
        <section class="container rtl mt-3">
            ...
            <div class="mt-3 mb-3 brand-slider">
                <div class="owl-carousel owl-theme p-2" id="brands-slider">
                    @foreach(\App\Model\Brand::active()->get() as $brand)
                            ...
                            <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}">
                                <div class="d-flex align-items-center justify-content-center"
                                    ...
                                    <img style="border-radius: 50%;"
                                        ...
                                        src="{{asset("storage/app/public/brand/".(\App\CPU\Helpers::get_prop('App\Model\Brand',$brand['id'],'image',session()->get('local')) ?? $brand->image))}}" alt="{{$brand->name}}">
                                </div>
                            </a>
                        </div>
                    @endforeach
...
<section class="container rtl mt-3">
    <div class="mt-3 mb-3 brand-slider">
        <div class="owl-carousel owl-theme p-2 rounded-lg" id="brands-slider">
            @foreach(\App\Model\Brand::active()->take(15)->get() ?? [] as $brand)
                <div class="text-center">
                    <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}">
                        <div class="d-flex align-items-center justify-content-center"
                            style="height:100px;margin:5px;">
                ...
                <div class="col-md-9" >
                    <div class="row">
                        ...
                        <div class="col-md-3 footer-padding-bottom" >
                            <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">{{\App\CPU\Helpers::translate('special')}}</h6>
                            <ul class="widget-list" style="padding-bottom: 10px">
                                ...
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('products',['data_from'=>'featured','page'=>1])}}">{{\App\CPU\Helpers::translate('featured_products')}}</a>
                                </li>
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('products',['data_from'=>'latest','page'=>1])}}">{{\App\CPU\Helpers::translate('latest_products')}}</a>
                                </li>
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('products',['data_from'=>'best-selling','page'=>1])}}">{{\App\CPU\Helpers::translate('best_selling_product')}}</a>
                                </li>
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('products',['data_from'=>'top-rated','page'=>1])}}">{{\App\CPU\Helpers::translate('top_rated_product')}}</a>
                                </li>
                        ...
                        <div class="col-md-4 footer-padding-bottom" style="{{(Session::get('direction') ?? 'rtl') === "rtl" ? 'padding-right:20px;' : ''}}">
                            ...
                            @if((auth('customer')->check() || auth('delegatestore')->check()))
                                <ul class="widget-list" style="padding-bottom: 10px">
                                    ...
                                    <li class="widget-list-item"><a class="widget-list-link"
                                                                    href="{{route('wishlists')}}">{{\App\CPU\Helpers::translate('wish_list')}}</a>
                                    </li>

                                    <li class="widget-list-item"><a class="widget-list-link"
                                                                    href="{{route('track-order.index')}}">{{\App\CPU\Helpers::translate('track_order')}}</a>
                                    </li>
                                    <li class="widget-list-item"><a class="widget-list-link"
                                                                    href="{{ route('account-address') }}">{{\App\CPU\Helpers::translate('address')}}</a>
                                    </li>
                            ...
                            @else
                                <ul class="widget-list" style="padding-bottom: 10px">
                                    <li class="widget-list-item"><a class="widget-list-link"
                                                                    href="{{route('customer.auth.login')}}">{{\App\CPU\Helpers::translate('profile_info')}}</a>
                                    </li>
                                    <li class="widget-list-item"><a class="widget-list-link"
                                                                    href="{{route('customer.auth.login')}}">{{\App\CPU\Helpers::translate('wish_list')}}</a>
                                    </li>
                                    ...
                                    <li class="widget-list-item"><a class="widget-list-link"
                                                                    href="{{route('customer.auth.login')}}">{{\App\CPU\Helpers::translate('address')}}</a>
                                    </li>
                        ...
                        <div class="col-md-5 footer-padding-bottom" >
                                ...
                                @if($ios['status'] || $android['status'])
                                    <div class="d-flex justify-content-center">
                                        <h6 class="text-uppercase font-weight-bold footer-heder align-items-center">
                                            {{\App\CPU\Helpers::translate('download_our_app')}}
                                        </h6>
                                    </div>
                                @endif
                                ...
                                <div class="text-nowrap mb-2">
                                    <span style="font-weight: 700;font-size: 14.3208px;">{{\App\CPU\Helpers::translate('NEWS LETTER')}}</span><br>
                                    <span style="font-weight: 400;font-size: 11.066px;">{{\App\CPU\Helpers::translate('subscribe to our new channel to get latest updates')}}</span>
                                </div>
