...
<aside style="text-align: {{(Session::get('direction') ?? 'rtl') === "rtl" ? 'right' : 'left'}};"
        ...
        <div class="navbar-vertical-container">
            <div class="navbar-vertical-footer-offset pb-0">
                <div class="navbar-brand-wrapper justify-content-between side-logo px-0" style="background-color: #373f50">
                    <!-- Logo -->
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard.index')}}" aria-label="Front">
                        <img
                             ...
                             class="navbar-brand-logo-mini for-web-logo w-50 mt-4 mx-4"
                             src="{{asset("storage/app/public/dashboard/$e_commerce_logo")}}" alt="Logo" style="width: 75% !important;">
                    </a>
                ...
                <!-- Content -->
                <div class="navbar-vertical-content" style="background-color:#373f50;">
                    ...
                    <ul class="navbar-nav" dir="{{Session::get('direction')}}" style="{{(Session::get('direction') ?? 'rtl') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        <li class="nav-item dropdown" onclick="$('.trfgv').toggle();">
                            ...
                            <ul class="bg-dark trfgv text-light border-0 dropdown-menu dropdown-menu-{{(Session::get('direction') ?? 'rtl') === "rtl" ? 'right' : 'left'}} scroll-bar"
                                ...
                                <li style="border-bottom: 1px solid #e3e9ef; display:flex; justify-content:center;">
                                    <div>
                                        <a class="dropdown-item text-light" href="{{route('brands')}}"
                                        style="color: {{$web_config['primary_color']}} !important;">
                                            {{ \App\CPU\Helpers::translate('View_more') }}
                                        </a>
                                    </div>
                                </li>
                            </ul>
                        ...
                        @if ($discount_product>0)
                            <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                                <a class="nav-link text-capitalize" href="{{route('products',['data_from'=>'discounted','page'=>1])}}">{{ \App\CPU\Helpers::translate('discounted_products')}}</a>
                            </li>
                        @endif
                        ...
                        @if ($business_mode == 'multi')
                            <li class="nav-item dropdown">
                                <a class="nav-link" href="{{route('sellers')}}">{{ \App\CPU\Helpers::translate('Sellers')}}</a>
                            </li>
                                ...
                                <li class="nav-item mx-4">
                                    <div class="dropdown">
                                        ...
                                        <div class="bg-dark text-light dropdown-menu border-0 qwfg" aria-labelledby="dropdownMenuButton"
                                            ...
                                            <a class="dropdown-item text-light border-0" href="{{route('seller.auth.login')}}">
