...
@section('content')
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-6">
                        <label class="form-label">{{ __('Date format') }} : <span
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-12 col-xl-4">
                        <label class="form-label">{{ __('Secondary color') }} : <span
                                class="red">*</span></label>
                        <div class="vironeer-color-picker input-group">
                            <span class="input-group-text colorpicker-input-addon">
                                <i></i>
                    ...
                    <div class="col-lg-12 col-xl-4">
                        <label class="form-label">{{ __('Mail templates color') }} : <span
                                class="red">*</span></label>
                        <div class="vironeer-color-picker input-group">
                            <span class="input-group-text colorpicker-input-addon">
                                <i></i>
                            </span>
                            <input type="text" name="website_mail_color" class="form-control"
                                value="{{ $settings['website_mail_color'] }}" required>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    ...
                    <div class="col-lg-3 col-xl-3">
                        <label class="form-label">{{ __('Force SSL') }} : <span
                                class="red">*</span></label>
                        <input type="checkbox" name="website_force_ssl_status" data-toggle="toggle"
                            @if ($settings['website_force_ssl_status']) checked @endif>
                    </div>
                    <div class="col-lg-3 col-xl-3">
                        <label class="form-label">{{ __('GDPR Cookie') }} : <span
                                class="red">*</span></label>
                        <input type="checkbox" name="website_cookie" data-toggle="toggle" @if ($settings['website_cookie']) checked @endif>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <button data-id="1" type="button"
                                class="vironeer-select-image-button btn btn-secondary btn-lg w-full mb-2">{{ __('Choose Dark Logo') }}</button>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <button data-id="2" type="button"
                                class="vironeer-select-image-button btn btn-secondary btn-lg w-full mb-2">{{ __('Choose Light Logo') }}</button>
                            <small class="text-muted">{{ __('Supported (PNG, JPG, JPEG, SVG)') }}</small>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        ...
                        <div class="mb-3">
                            ...
                            <button data-id="3" type="button"
                                class="vironeer-select-image-button btn btn-secondary btn-lg w-full mb-2">{{ __('Choose Favicon') }}</button>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <button data-id="4" type="button"
                                class="vironeer-select-image-button btn btn-secondary btn-lg w-full mb-2">{{ __('Choose Social Image') }}</button>
    ...
    @push('styles_libs')
        <link rel="stylesheet" href="{{ asset('/public/assets/vendor/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.css') }}">
    @endpush
    @push('scripts_libs')
        <script src="{{ asset('/public/assets/vendor/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.js') }}"></script>
    @endpush
    @push('scripts')
        <script>
            $(function() {
