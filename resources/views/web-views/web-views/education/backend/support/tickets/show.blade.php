        ...
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                    <a href="{{ route('users.edit', $ticket->user->id) }}">
                        <img class="border rounded-circle border-2" src="{{ asset($ticket->user->avatar) }}" width="60"
                            height="60">
                    </a>
                </div>
                <div class="flex-grow-1 ms-3">
                    <a href="{{ route('users.edit', $ticket->user->id) }}" class="text-dark">
                        <h5 class="mb-1">
                ...
                @foreach ($replies as $reply)
                    @if ($reply->admin_id == null)
                        <li class="vironeer-chat-message d-flex justify-content-between">
                            ...
                            <div class="card bg-digitalocean text-white w-full">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <p class="fw-bold">
                                            {{ $ticket->user->firstname . ' ' . $ticket->user->lastname }}
                    ...
                    @else
                        <li class="vironeer-chat-message d-flex justify-content-between">
                            <div class="card w-full bg-white text-dark">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
