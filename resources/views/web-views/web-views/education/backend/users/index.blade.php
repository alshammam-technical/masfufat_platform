        ...
        <div>
            @if ($users->count() > 0)
                <div class="table-responsive">
                    <table class="vironeer-normal-table table w-full">
                        <thead>
                            <tr>
                                <th class="tb-w-3x">#</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="vironeer-user-box">
                                            <a class="vironeer-user-avatar" href="{{ route('users.edit', $user->id) }}">
                                                <img src="{{ asset($user->avatar) }}" alt="User" />
                                            </a>
                                            <div>
                                                <a class="text-reset"
                                                    href="{{ route('users.edit', $user->id) }}">{{ $user->firstname . ' ' . $user->lastname }}</a>
