        ...
        <div class="container__payment">
            ...
            <div class="form-payment">
                <div class="products">
                    ...
                    <div class="total">{{\App\CPU\Helpers::translate('amount_to_be_paid')}}<span class="price">{{\App\CPU\Helpers::set_symbol($order_amount)}}</span></div>
                </div>
                <div class="payment-details">
                    <form id="form-checkout">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12">
                                <br>
                                <button id="form-checkout__submit" type="submit" class="btn bg-primaryColor btn-block text-light">Pay</button>
                                <br>
        ...
        const cardForm = mercadopago.cardForm({
            ...
            form: {
                ...
                cardholderName: {
                    ...
                    placeholder: "{{\App\CPU\Helpers::translate('card_holder_name')}}",
                },
                cardholderEmail: {
                    id: "form-checkout__cardholderEmail",
                    placeholder: "{{\App\CPU\Helpers::translate('card_holder_email')}}",
                },
                cardNumber: {
                    id: "form-checkout__cardNumber",
                    placeholder: "{{\App\CPU\Helpers::translate('card_number')}}",
                },
                cardExpirationMonth: {
                ...
                securityCode: {
                    ...
                    placeholder: "{{\App\CPU\Helpers::translate('security_code')}}",
                },
                installments: {
                    id: "form-checkout__installments",
                    placeholder: "{{\App\CPU\Helpers::translate('installments')}}",
                },
                identificationType: {
                ...
                identificationNumber: {
                    ...
                    placeholder: "{{\App\CPU\Helpers::translate('identification_number')}}",
                },
                issuer: {
                    id: "form-checkout__issuer",
                    placeholder: "{{\App\CPU\Helpers::translate('issuer')}}",
                },
            },
            callbacks: {
                onFormMounted: error => {
