            ...
            <div class="col-md-9  ">
                ...
                <div class="mt-3">
                    <button type="submit" class="btn btn-p btn-b float-right" data-bs-toggle="modal"
                            data-bs-target="#exampleModal">{{\App\CPU\Helpers::translate('Add New Address')}}
                    </button>
                </div>
            </div>
        </div>
            ...
            <div class="sidebarR col-lg-3">
                ...
                <div class="price_sidebar rounded-lg box-shadow-sm" id="shop-sidebar" style="margin-bottom: -10px;">
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class="sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;">
                                <a href="{{ route('orderList') }}" style="color: #1B7FED">{{\App\CPU\Helpers::translate('My Orders')}}</a>
                            </h3>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a href="{{ route('wishList') }}">
                                    {{\App\CPU\Helpers::translate('Wish List')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        <!-- Filter by price-->
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a href=""> {{\App\CPU\Helpers::translate('Chat With Sellers')}} </a>
                            </h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a href="{{ route('profile') }}">
                                    {{\App\CPU\Helpers::translate('Profile Info')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        <!-- Filter by price-->
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a href="">{{\App\CPU\Helpers::translate('Address')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href="{{ route('support-ticket') }}">{{\App\CPU\Helpers::translate('Support ticket')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        <!-- Filter by price-->
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a href="">{{\App\CPU\Helpers::translate('Transaction history')}} </a>
                            </h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-1" style="padding-top: 12px;">
                        <!-- Filter by price-->
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a href="">{{\App\CPU\Helpers::translate('Payment method')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
        ...
        <div class="col-md-6">
            <div class="card cardColor">
                <div class="card-header">
                    ...
                    <span class="namHad">{{\App\CPU\Helpers::translate('Permanent Address')}}</span>
                    <span class="float-right iconSp">
                            <i class="fa fa-edit fa-lg"></i>
                            <i class="ri-delete-bin-5-fill fa-lg"></i>
                        </span>
                </div>
                <div class="card-body">
                    <div class="font-name"><span> {{\App\CPU\Helpers::translate('Abdur Rahim')}}</span></div>
                    <div><span class="font-nameA">{{\App\CPU\Helpers::translate('3rd Floor,D block')}}</span></div>
                    <div><span class="font-nameA">{{\App\CPU\Helpers::translate('Dhaka 1100')}}</span></div>
                    <div><span class="font-nameA">{{\App\CPU\Helpers::translate('Bangladesh')}}</span></div>
                    <div><span class="font-nameA">{{\App\CPU\Helpers::translate('0088 01251548524')}}</span></div>
        ...
        <div class="col-md-6 div-secon">
            <div class="card cardColor">
                <div class="card-header ">
                    ...
                    <span class="namHad">{{\App\CPU\Helpers::translate('Home Address')}}</span>
                    <span class="float-right iconSp">
                                <i class="fa fa-edit fa-lg"></i>
                                <i class="ri-delete-bin-5-fill fa-lg"></i>
                            </span>
        ...
        <div class="col-md-6">
            <div class="card cardColor">
                <div class="card-header">
                    ...
                    <span class="namHad"> {{\App\CPU\Helpers::translate('Office Address')}}</span>
                    <span class="float-right iconSp">
                            <i class="fa fa-edit fa-lg"></i>
                            <i class="ri-delete-bin-5-fill fa-lg"></i>
                        </span>
