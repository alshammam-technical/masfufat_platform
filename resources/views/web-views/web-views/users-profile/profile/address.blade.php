...
@section('title',\App\CPU\Helpers::translate('Home'))
    ...
    <div class="container pb-5 mb-2 mb-md-4 mt-3">
        <div class="row">
            ...
            <div class="sidebarR col-lg-3">
                ...
                <div class="price_sidebar rounded-lg box-shadow-sm" id="shop-sidebar" style="margin-bottom: -10px;">
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class="sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a href="{{ route('orderList') }}"
                                                                                       style="color: #1B7FED">{{\App\CPU\Helpers::translate('My Orders')}}</a>
                            </h3>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href="{{ route('wishList') }}"> {{\App\CPU\Helpers::translate('Wish List')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href=""> {{\App\CPU\Helpers::translate('Chat With Sellers')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href="{{ route('profile') }}"> {{\App\CPU\Helpers::translate('Profile Info')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href="">{{\App\CPU\Helpers::translate('Address')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class=" sidebarL">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href="{{ route('support-ticket') }}">{{\App\CPU\Helpers::translate('Support ticket')}} </a>
                            </h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-0" style="padding-top: 12px;">
                        ...
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href="">{{\App\CPU\Helpers::translate('Transaction history')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
                    ...
                    <div class="pb-1" style="padding-top: 12px;">
                        ...
                        <div class="sidebarL ">
                            <h3 class="widget-title btnF" style="font-weight: 700;"><a
                                    href="">{{\App\CPU\Helpers::translate('Payment method')}} </a></h3>
                            <div class="divider-role"
                                 style="border: 1px solid whitesmoke; margin-bottom: 14px;  margin-top: -6px;"></div>
            ...
            <section class="col-lg-9 mt-3">
                <span style="color: #6A6A6A">{{\App\CPU\Helpers::translate('No address found')}}.</span>
                            ...
                            <div class="modal-header">
                                <div class="row">
                                    <div class="col-md-12"><h5
                                            class="modal-title font-nameA ">{{\App\CPU\Helpers::translate('Add a new address')}}</h5>
                                    </div>
                                </div>
                            ...
                            <div class="modal-body">
                                <form class="">
                                    ...
                                    <ul class="nav nav-pills ml-3" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active btn-p" data-bs-toggle="pill"
                                               href="#home">{{\App\CPU\Helpers::translate('Permanent')}}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="pill"
                                               href="#menu1">{{\App\CPU\Helpers::translate('Home')}}</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="pill"
                                               href="#menu2">{{\App\CPU\Helpers::translate('Office')}}</a>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="tab-content">
                                        <div id="home" class="container tab-pane active"><br>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label
                                                        for="firstName">{{\App\CPU\Helpers::translate('Contact person name')}}</label>
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button"
                                                    class="btn btn-p"> {{\App\CPU\Helpers::translate('Update Information')}}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div class="mt-3">
            <button type="submit" class="btn btn-p btn-b float-right" data-bs-toggle="modal" data-bs-target="#exampleModal">
                {{\App\CPU\Helpers::translate('Add New Address')}}
            </button>
        </div>
    </div>
