...
Route::group(['namespace' => 'Customer', 'prefix' => 'customer', 'as' => 'customer.'], function () {
    ...
    Route::group(['namespace' => 'Auth', 'prefix' => 'auth', 'as' => 'auth.'], function () {
        ...
        Route::post('phone_login', 'LoginController@submit_phone')->name('phone');
        Route::get('code_login', 'LoginController@login_code')->name('code');
        Route::post('code_login', 'LoginController@submit_code');
        Route::get('logout', 'LoginController@logout')->name('logout');

        Route::post('check_', 'RegisterController@check')->name('check_');
    ...
    Route::post('/customer-subscription-request', 'PaymentController@customer_subscription_request')->name('customer-subscription-request');
