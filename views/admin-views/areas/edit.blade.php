...
<div class="content container-fluid">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <form action="{{route('admin.areas.update',$b['id'])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @php
                                ...
                                @foreach(Helpers::get_langs() as $i=>$lang)
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                        ...
                                        <label class="title-color" for="name">
                                            {{ \App\CPU\Helpers::translate('Service name')}} ({{strtoupper($lang)}})
                                        ...
                                        value="{{ \App\CPU\Helpers::get_prop('App\areas',$b['id'],'name',$lang) }}"
                        ...
                        <div hidden class="d-flex justify-content-end gap-3">
                            <button hidden type="submit" class="btn-save btn btn--primary btn-primary px-4">{{ \App\CPU\Helpers::translate('update')}}</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <!--modal-->
    @include('shared-partials.image-process._image-crop-modal',['modal_id'=>'area-image-modal','width'=>1000,'margin_left'=>'-53%'])
    <!--modal-->
</div>
@endsection
