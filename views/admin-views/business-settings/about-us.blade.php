        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">{{\App\CPU\Helpers::translate('about_us')}}</h5>
                </div>
                        ...
                        @foreach(Helpers::get_langs() as $lang)
                            <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                <div class="form-group">
                                    <textarea name="about_us[{{$lang}}]" id="textarea{{$lang}}" cols="30" rows="20" class="form-control textarea{{$lang}}">{{$about_us->value}}</textarea>
                                </div>
                            </div>
                        @endforeach
                        <div class="form-group mb-2">
                            <input class="btn btn--primary btn-primary btn-block btn-save d-none" type="submit" name="btn" value="submit">
                        </div>
                    </div>
                </form>
