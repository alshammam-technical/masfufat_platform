...
@section('title', \App\CPU\Helpers::translate('app_settings'))
    ...
    <div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 24%">
        ...
        <div class="pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('apps settings')}}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <div class="row">
            <div class="col-12 col-md-6 mb-3">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{\App\CPU\Helpers::translate('app status in app store (App Store)')}}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <form style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                            ...
                            @if(isset($config))
                                ...
                                <div class="form-group">
                                    <label class="title-color">{{\App\CPU\Helpers::translate('link')}}</label><br>
            ...
            <div class="col-12 col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{\App\CPU\Helpers::translate('app status in app store (Google Play)')}}</h5>
                    </div>
                    <div class="card-body">
