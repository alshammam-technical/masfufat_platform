...
@section('title', \App\CPU\Helpers::translate('Delivery_Restriction'))
    ...
    <div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 24%">
        ...
        <div class="pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('delivery_restriction')}}
            </h2>
        </div>
        <!-- End Page Title -->
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <h5 class="mb-0 text-capitalize d-flex gap-1">
                            ...
                            {{\App\CPU\Helpers::translate('delivery_available_country')}}
                        </h5>
                    ...
                    <div class="card-body country-disable">
                        <div class="row">
                            @if(Helpers::module_permission_check('delivery-restriction-countries.add'))
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table id="datatable"
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center">{{\App\CPU\Helpers::translate('country_name')}}</th>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <div class="text-center p-4">
                                                        ...
                                                        <p class="mb-0">{{\App\CPU\Helpers::translate('No Country Found')}}</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
            ...
            <div class="col-md-6">
                <div class="card mb-3">
                    <div class="card-header">
                        <h5 class="mb-0 text-capitalize d-flex gap-1">
                            <i class="tio-briefcase"></i>
                            {{\App\CPU\Helpers::translate('delivery_available_zip_code_area')}}
                        </h5>
                        <label class="switcher">
                    ...
                    <div class="card-body zip-disable">
                        <div class="row">
                            @if(Helpers::module_permission_check('delivery-restriction-zip.add'))
                            <div class="col-lg-12">
                                <form action="{{ route('admin.business-settings.delivery-restriction.add-zip-code') }}"
                                      method="post">
                                    @csrf
                                    <label class="title-color d-flex"> {{\App\CPU\Helpers::translate('zip_code')}} </label>

                                    <input type="text" class="form-control" name="zipcode"
                                           placeholder="{{ \App\CPU\Helpers::translate('enter_zip_code') }}"
                                           data-role="tagsinput" required>
                                    <span class="pl-2 text-info">({{\App\CPU\Helpers::translate('multiple_zip_codes_can_be_inputted_by_comma_separating_or_pressing_enter_button')}})</span>
                            ...
                            <div class="col-md-12 mt-6">
                                <div class="table-responsive">
                                    <table id="datatable"
                                        ...
                                        <tr>
                                            <th>{{\App\CPU\Helpers::translate('sl')}}</th>
                                            <th class="text-center">{{\App\CPU\Helpers::translate('zip_code')}}</th>
                                            <th class="text-center">{{\App\CPU\Helpers::translate('action')}}</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <a class="btn btn-outline-danger btn-sm square-btn"
                                                           href="javascript:"
                                                           title="{{\App\CPU\Helpers::translate('Delete')}}"
                                                           onclick="form_alert('product-z{{$zip->id}}','Want to delete this item ?')">
                                                            <i class="tio-delete"></i>
                                                        </a>
                                                        <form
                                                            action="{{route('admin.business-settings.delivery-restriction.zip-code-delete',['id' => $zip->id])}}"
                                                            method="post" id="product-z{{$zip->id}}">
                                                            @csrf @method('delete')
                                                        </form>
                                                    </div>
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="3">
                                                    <div class="text-center p-4">
                                                        <img class="mb-3 w-160" src="{{asset('public/assets/back-end')}}/svg/illustrations/sorry.svg" alt="Image Description">
                                                        <p class="mb-0">{{\App\CPU\Helpers::translate('No Zip Code Found')}}</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
