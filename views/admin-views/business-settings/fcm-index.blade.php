...
@section('title', \App\CPU\Helpers::translate('FCM Settings'))
    ...
    <div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 24%">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('Push_Notification_Setup')}}
            </h2>
        </div>
        <!-- End Page Title -->
    ...
    <!-- End Inlile Menu -->
        ...
        <div class="row gx-2 gx-lg-3">
            <div class="col-12 mb-3">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{\App\CPU\Helpers::translate('Firebase Push Notification Setup')}}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.business-settings.update-fcm')}}" method="post"
                            ...
                            <div class="form-group">
                                <label class="title-color"
                                       for="exampleFormControlInput1">{{\App\CPU\Helpers::translate('Server Key')}}</label>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CPU\Helpers::translate('FCM Project ID')}}</label>
            ...
            <div class="col-12 mb-3">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{\App\CPU\Helpers::translate('Push Messages')}}</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.business-settings.update-fcm-messages')}}" method="post"
                            ...
                            <div class="row">
                                ...
                                @php($dbc=\App\Model\BusinessSetting::where('type','sign_up_message')->first()->value)
                                @php($data=json_decode($dbc,true))
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            <label class="switcher" for="sign_up">
                                                <input type="checkbox" name="sign_up_status"
                                                       class="switcher_input"
                                                       value="1"
                                                       id="sign_up" {{$data['status']==1?'checked':''}}>
                                                <span class="switcher_control"></span>
                                            </label>
                                            <label for="sign_up"
                                                class="switcher_content">{{\App\CPU\Helpers::translate('sign_up')}}</label>
                                        </div>

                                        <textarea name="sign_up_message" class="form-control">{{$data['message']}}</textarea>
                                    </div>
                                </div>

                                @php($dbc=\App\Model\BusinessSetting::where('type','login_message')->first()->value)
                                @php($data=json_decode($dbc,true))
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            <label class="switcher" for="login">
                                                <input type="checkbox" name="login_status"
                                                       class="switcher_input"
                                                       value="1"
                                                       id="login" {{$data['status']==1?'checked':''}}>
                                                <span class="switcher_control"></span>
                                            </label>
                                            <label for="login"
                                                class="switcher_content">{{\App\CPU\Helpers::translate('login')}}</label>
                                        </div>

                                        <textarea name="login_message" class="form-control">{{$data['message']}}</textarea>
                                    </div>
                                </div>

                                @php($dbc=\App\Model\BusinessSetting::where('type','discount_message')->first()->value)
                                @php($data=json_decode($dbc,true))
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            <label class="switcher" for="discount">
                                                <input type="checkbox" name="discount_status"
                                                       class="switcher_input"
                                                       value="1"
                                                       id="discount" {{$data['status']==1?'checked':''}}>
                                                <span class="switcher_control"></span>
                                            </label>
                                            <label for="discount"
                                                class="switcher_content">{{\App\CPU\Helpers::translate('discount')}}</label>
                                        </div>

                                        <textarea name="discount_message" class="form-control">{{$data['message']}}</textarea>
                                    </div>
                                </div>

                                @php($dbc=\App\Model\BusinessSetting::where('type','forgot_password_message')->first()->value)
                                @php($data=json_decode($dbc,true))
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            <label class="switcher" for="forgot_password">
                                                <input type="checkbox" name="forgot_password_status"
                                                       class="switcher_input"
                                                       value="1"
                                                       id="forgot_password" {{$data['status']==1?'checked':''}}>
                                                <span class="switcher_control"></span>
                                            </label>
                                            <label for="forgot_password"
                                                class="switcher_content">{{\App\CPU\Helpers::translate('forgot_password')}}</label>
                                        </div>

                                        <textarea name="forgot_password_message" class="form-control">{{$data['message']}}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="pending_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('Order Pending Message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="confirm_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('Order Confirmation Message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="processing_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('Order Processing Message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="out_for_delivery"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('Order out for delivery Message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="delivered_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('Order Delivered Message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="returned_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('Order Returned Message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="failed_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('Order Failed Message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="delivery_boy_assign"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('deliveryman assign message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="delivery_boy_start_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('deliveryman start message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="delivery_boy_delivered"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('deliveryman delivered message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="delivery_boy_expected_delivery_date_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('deliveryman reschedule message')}}</label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex align-items-center mb-3 flex-wrap gap-10">
                                            ...
                                            <label for="order_canceled_status"
                                                   class="switcher_content">{{\App\CPU\Helpers::translate('order canceled message')}}</label>
                                        </div>
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                        onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                                        class="btn btn--primary btn-primary px-4">{{\App\CPU\Helpers::translate('save')}}
                                </button>
                            </div>
                        </form>
                    </div>
