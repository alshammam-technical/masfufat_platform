...
@section('title', \App\CPU\Helpers::translate('General Setting'))
...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page">{{\App\CPU\Helpers::translate('General settings')}}</li>
        </ol>
    </nav>

    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h4 class="mb-0 text-black-50">{{\App\CPU\Helpers::translate('General Business Settings')}}</h4>
    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row justify-content-between pl-4 pr-4">
                        <div>
                            <h5>{{\App\CPU\Helpers::translate('Language Table')}}</h5>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="table-responsive">
                            <table id="table_id" class="display table table-hover " style="width:100%">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{\App\CPU\Helpers::translate('ID')}}</th>
                                    <th scope="col">{{\App\CPU\Helpers::translate('Name')}}</th>
                                    <th scope="col">{{\App\CPU\Helpers::translate('Code')}}</th>
