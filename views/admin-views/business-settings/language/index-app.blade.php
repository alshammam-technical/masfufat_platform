...
@section('title', \App\CPU\Helpers::translate('Language'))
    ...
    <div class="content container-fluid">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\Helpers::translate('language_setting for_app')}}</li>
            </ol>
        </nav>
        ...
        <div class="row" style="margin-top: 20px">
            <div class="col-md-12">
                <div class="alert alert-warning sticky-top" id="alert_box" style="display:none;">
                    ...
                    <strong>{{\App\CPU\Helpers::translate('Warning')}}!</strong> {{\App\CPU\Helpers::translate('Follow the documentation to setup from app end')}}, <a
                        href="https://documentation.6amtech.com/sixvalley-ecommerce/docs/1.0/app-setup#section3"
                        target="_blank">{{\App\CPU\Helpers::translate('click')}}
                        {{\App\CPU\Helpers::translate('here')}}</a>.
                </div>
                <div class="card">
                    <div class="card-header">
                        <h4>{{\App\CPU\Helpers::translate('Select Country code')}}
                            {{\App\CPU\Helpers::translate('for product and category language')}}</h4>
                        <label class="badge badge-danger">* {{\App\CPU\Helpers::translate('For mobile app only')}}</label>
                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.business-settings.web-config.update-language')}}" method="post">
                            ...
                            <button type="submit"
                                    class="btn btn--primary btn-primary float-right ml-3">{{\App\CPU\Helpers::translate('Save')}}</button>
                        </form>
                    </div>
                </div>
            </div>
