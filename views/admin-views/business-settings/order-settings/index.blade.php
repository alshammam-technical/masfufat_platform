...
@section('title', \App\CPU\Helpers::translate('order_settings'))
...
<div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 24%">
        ...
        <div class="mb-4 pb-2">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('order_settings')}}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="card-body">
                <form action="{{route('admin.business-settings.order-settings.update-order-settings')}}" method="post" enctype="multipart/form-data" id="add_fund">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="d-flex gap-1 mb-2">
                                    <label class="title-color mb-0">{{\App\CPU\Helpers::translate('Show_Billing_Address_In_Checkout')}}</label>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="billing_input_by_customer1">{{\App\CPU\Helpers::translate('active')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="billing_input_by_customer2">{{\App\CPU\Helpers::translate('deactive')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="submit" id="submit" class="btn btn--primary btn-primary px-4 btn-save d-none">{{\App\CPU\Helpers::translate('submit')}}</button>
                    </div>
                </form>
            </div>
            <!-- End Table -->
