            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">{{\App\CPU\Helpers::translate('privacy_policy')}}</h5>
                    </div>
                    ...
                    <form action="{{route('admin.business-settings.privacy-policy')}}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form" id="{{$lang}}-form">
                                <textarea class="form-control textarea{{$lang}}" id="textarea{{$lang}}" name="value[{{$lang}}]">{{json_decode($privacy_policy->value)->$lang ?? ''}}</textarea>
                            </div>
                            @endforeach
