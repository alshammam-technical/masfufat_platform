...
@section('title', \App\CPU\Helpers::translate('general_settings'))
...
@include('admin-views.business-settings.settings-inline-menu')
    <div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 24%">
            ...
            <div class="card-body">
                <div class="border rounded border-color-c1 px-4 py-3 d-flex justify-content-between mb-1">
                    ...
                    <h5 class="mb-0 d-flex gap-1 c1">
                        ...
                        {{\App\CPU\Helpers::translate('maintenance_mode')}}
                    </h5>
                ...
                <p>*{{Helpers::translate('By turning on maintaince mode, all your app and customer side website will be off. Only admin panel and seller panel will be functional')}}</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.business-settings.update-info') }}" method="POST"
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="mb-0 text-capitalize d-flex gap-1">
                        ...
                        {{\App\CPU\Helpers::translate('Company_Information')}}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('company name')}}</label>
                        ...
                        <div class="col-md-4">
                            @php($companyName_en=\App\Model\BusinessSetting::where('type','company_name_en')->first())
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('company name in english')}}</label>
                                <input class="form-control" type="text" name="company_name_en"
                                    value="{{ $companyName_en->value ?? '' }}"
                                    placeholder="New Business">
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex">{{\App\CPU\Helpers::translate('Phone')}}</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('Email')}}</label>
                        ...
                        <div class="col-md-4">
                            @php($company_tax_no=\App\Model\BusinessSetting::where('type','company_tax_no')->first())
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('company_tax_number')}}</label>
                                <input class="form-control" type="text" name="company_tax_no"
                                    value="{{ isset($company_tax_no->value)?$company_tax_no->value:" " }}"
                                    placeholder="New Business">
                            </div>
                        </div>

                        <div class="col-md-4">
                            @php($company_commercial_register=\App\Model\BusinessSetting::where('type','company_commercial_register')->first())
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('company_commercial_register')}}</label>
                                <input class="form-control" type="text" name="company_commercial_register"
                                    value="{{ isset($company_commercial_register->value)?$company_commercial_register->value:" " }}"
                                    placeholder="New Business">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex">{{\App\CPU\Helpers::translate('company_address')}}</label>
                                <input type="text" value="{{isset($shop_address)!=null?$shop_address:''}}"
                                    name="shop_address" class="form-control"
                                    placeholder="{{\App\CPU\Helpers::translate('Your_shop_address')}}"
                                    required>
                            </div>
                        </div>
                        <div class="col-md-4">
                            @php($shop_address_en=\App\CPU\Helpers::get_business_settings('shop_address_en') ?? '')
                            <div class="form-group">
                                <label class="title-color d-flex">{{\App\CPU\Helpers::translate('company_address in english')}}</label>
                                <input type="text" value="{{isset($shop_address_en)!=null?$shop_address_en:''}}"
                                    name="shop_address_en" class="form-control"
                                    placeholder="{{\App\CPU\Helpers::translate('Your_shop_address in english')}}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('latitude')}}</label>
                                <input class="form-control" type="text" name="latitude"
                                    value="{{ isset($default_location)?$default_location['lat']:'' }}"
                                    placeholder="{{\App\CPU\Helpers::translate('latitude')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('longitude')}}</label>
                                <input class="form-control" type="text" name="longitude"
                                    value="{{ isset($default_location)?$default_location['lng']:'' }}"
                                    placeholder="{{\App\CPU\Helpers::translate('longitude')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex">{{\App\CPU\Helpers::translate('time zone')}}</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex">{{\App\CPU\Helpers::translate('country')}} </label>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <h5 class="mb-0 text-capitalize d-flex gap-1">
                        ...
                        {{\App\CPU\Helpers::translate('business_Information')}}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <label class="title-color d-flex">{{\App\CPU\Helpers::translate('Currency Position')}}</label>
                            <div class="form-row">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio custom-radio-reverse"
                                            ...
                                            <label class="custom-control-label media align-items-center"
                                                ...
                                                {{\App\CPU\BackEndHelper::currency_symbol()}} {{\App\CPU\Helpers::translate('Left')}}
                                                </span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio custom-radio-reverse"
                                            ...
                                            <label class="custom-control-label media align-items-center"
                                                ...
                                                <span
                                                    class="media-body">{{\App\CPU\Helpers::translate('Right')}} {{\App\CPU\BackEndHelper::currency_symbol()}}</span>
                                            </label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="title-color d-flex">{{\App\CPU\Helpers::translate('forgot_password_verification_by')}} </label>
                                <select name="forgot_password_verification" class="form-control  js-select2-custom">
                                    <option value="email" {{ isset($fpv)?($fpv=='email'?'selected':''):'' }} >{{Helpers::translate('Email')}}</option>
                                    <option value="phone" {{ isset($fpv)?($fpv=='phone'?'selected':''):'' }} >{{Helpers::translate('Phone')}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{\App\CPU\Helpers::translate('OTP verification')}}<span class="text-danger">*</span></label>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="phone_verification_on">{{\App\CPU\Helpers::translate('on')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="phone_verification_off">{{\App\CPU\Helpers::translate('off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{\App\CPU\Helpers::translate('email verification')}}<span class="text-danger">*</span></label>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="email_verification_on">{{\App\CPU\Helpers::translate('on')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="email_verification_off">{{\App\CPU\Helpers::translate('off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex gap-1">{{\App\CPU\Helpers::translate('order verification')}}<span class="text-danger">*</span></label>
                                ...
                                <div class="input-group input-group-md-down-break">
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="order_verification1">{{\App\CPU\Helpers::translate('on')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                    ...
                                    <div class="form-control">
                                        <div class="custom-control custom-radio">
                                            ...
                                            <label class="custom-control-label"
                                                for="order_verification2">{{\App\CPU\Helpers::translate('off')}}</label>
                                        </div>
                                    </div>
                                    <!-- End Custom Radio -->
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label class="title-color d-flex">{{\App\CPU\Helpers::translate('Company_Copyright_Text')}}</label>
                                <input class="form-control" type="text" name="company_copyright_text"
                                    ...
                                    placeholder="{{\App\CPU\Helpers::translate('company_copyright_text')}}">
                            </div>
                        </div>
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                    class="title-color d-flex">{{\App\CPU\Helpers::translate('pagination settings')}}</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label
                                class="input-label text-capitalize">{{\App\CPU\Helpers::translate('digit_after_decimal_point ')}}({{\App\CPU\Helpers::translate(' ex: 0.00')}})</label>
                                <input type="number" value="{{$decimal_point->value}}"
                                name="decimal_point_settings" class="form-control" min="0" placeholder="{{\App\CPU\Helpers::translate('4')}}">
                            </div>
                        </div>

                        <div class="col-md-4">
                            <label class="title-color d-flex mb-3">{{\App\CPU\Helpers::translate('show notifications in favorate')}}</label>
                            <div class="row">
                                <div class="col-4 d-flex gap-2 align-items-center mb-2">
                                    <input class="" name="show_notifications_in_fav" type="radio" value="1"
                                    id="defaultCheck3" {{$show_notifications_in_fav=='1'?'checked':''}}>
                                ...
                                <div class="col-6 d-flex gap-2 align-items-center">
                                    <input class="" name="show_notifications_in_fav" type="radio" value="0"
                                    id="defaultCheck4" {{$show_notifications_in_fav=='0'?'checked':''}}>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex align-items-center gap-2">
                                ...
                                {{\App\CPU\Helpers::translate('Website Color')}}
                            </h5>
                        </div>
                        <div class="card-body d-flex flex-wrap gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    ...
                                    <label class="title-color text-capitalize">{{\App\CPU\Helpers::translate('Primary_Color')}}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="text-center">
                                    ...
                                    <label class="title-color text-capitalize">
                                        {{\App\CPU\Helpers::translate('Secondary Color')}}
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                ...
                                {{\App\CPU\Helpers::translate('Loading Gif')}}
                            </h5>
                            <span class="badge badge-soft-info">( {{\App\CPU\Helpers::translate('ratio 1:1 ')}}  )</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="position-relative mt-4">
                                ...
                                <label class="custom-file-label"
                                        for="customFileUploadLoader">{{\App\CPU\Helpers::translate('choose file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('App_Logo')}}
                            </h5>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="mt-4 position-relative">
                                <input type="file" name="company_mobile_logo" id="customFileUploadML"
                                        ...
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadML">{{\App\CPU\Helpers::translate('choose file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                ...
                                {{\App\CPU\Helpers::translate('landing page Header Logo')}}
                            </h5>
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            ...
                            <div class="mt-4 position-relative">
                                <input type="file" name="company_web_logo" id="customFileUploadWL"
                                        ...
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadWL">{{\App\CPU\Helpers::translate('choose file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/header-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('Dashboard Header Logo')}}
                            </h5>
                            <span class="badge badge-soft-info">( 250x60 px )</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerWLL"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/app/public/dashboard')}}/{{\App\Model\BusinessSetting::where(['type' => 'company_admin_logo'])->pluck('value')[0]}}">
                            </center>
                            <div class="mt-4 position-relative">
                                <input type="file" name="company_admin_logo" id="customFileUploadWLL"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadWL">{{\App\CPU\Helpers::translate('choose file')}}</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('Admin Favicon')}}
                            </h5>
                            <span class="badge badge-soft-info">( {{\App\CPU\Helpers::translate('ratio 1:1 ')}})</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFI3"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/app/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'admin_fav_icon'])->pluck('value')[0]}}">
                            </center>
                            <div class="position-relative mt-4">
                                <input type="file" name="admin_fav_icon" id="customFileUploadFI3"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadFI">{{\App\CPU\Helpers::translate('choose file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('Sellers Favicon')}}
                            </h5>
                            <span class="badge badge-soft-info">( {{\App\CPU\Helpers::translate('ratio 1:1 ')}})</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFI2"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/app/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'seller_fav_icon'])->pluck('value')[0]}}">
                            </center>
                            <div class="position-relative mt-4">
                                <input type="file" name="seller_fav_icon" id="customFileUploadFI2"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadFI">{{\App\CPU\Helpers::translate('choose file')}}</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('Website Favicon')}}
                            </h5>
                            <span class="badge badge-soft-info">( {{\App\CPU\Helpers::translate('ratio 1:1 ')}})</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFI"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/app/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'shop_fav_icon'])->pluck('value')[0]}}">
                            </center>
                            <div class="position-relative mt-4">
                                <input type="file" name="shop_fav_icon" id="customFileUploadFI"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadFI">{{\App\CPU\Helpers::translate('choose file')}}</label>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('Website header icon')}}
                            </h5>
                            <span class="badge badge-soft-info">( {{\App\CPU\Helpers::translate('ratio 1:1 ')}})</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFIH"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/app/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'shop_header_icon'])->pluck('value')[0] ?? ''}}">
                            </center>
                            <div class="position-relative mt-4">
                                <input type="file" name="shop_header_icon" id="customFileUploadFIH"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadFIH">{{\App\CPU\Helpers::translate('choose file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('Website footer logo')}}
                            </h5>
                            <span class="badge badge-soft-info">( {{\App\CPU\Helpers::translate('ratio 1:1 ')}})</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFIF"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/app/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'shop_fav_icon_footer'])->pluck('value')[0]}}">
                            </center>
                            <div class="position-relative mt-4">
                                <input type="file" name="shop_fav_icon_footer" id="customFileUploadFIF"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadFIF">{{\App\CPU\Helpers::translate('choose file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="card h-100">
                        <div class="card-header">
                            <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2">
                                <img src="{{asset('/public/assets/back-end/img/footer-logo.png')}}" alt="">
                                {{\App\CPU\Helpers::translate('All products icon (for application)')}}
                            </h5>
                            <span class="badge badge-soft-info">( {{\App\CPU\Helpers::translate('ratio 1:1 ')}})</span>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-around">
                            <center>
                                <img height="60" id="viewerFIFz"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                        src="{{asset('storage/app/public/company')}}/{{\App\Model\BusinessSetting::where(['type' => 'all_products_icon'])->pluck('value')[0]}}">
                            </center>
                            <div class="position-relative mt-4">
                                <input type="file" name="all_products_icon" id="customFileUploadFIFz"
                                        class="custom-file-input"
                                        accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label"
                                        for="customFileUploadFIFz">{{\App\CPU\Helpers::translate('choose file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-end d-none" hidden>
                <button type="submit" class="btn btn--primary btn-primary px-4 btn-save d-none" hidden>{{\App\CPU\Helpers::translate('Submit')}}</button>
            </div>
        </form>
    </div>
@endsection
...
@push('script')
    ...
    <script>
        ...
        $("#customFileUploadWLL").change(function () {
            read_image(this, 'viewerWLL');
        });
        ...
        $("#customFileUploadFIH").change(function () {
            read_image(this, 'viewerFIH');
        });

        $("#customFileUploadFIF").change(function () {
            read_image(this, 'viewerFIF');
        });

        $("#customFileUploadFIFz").change(function () {
            read_image(this, 'viewerFIFz');
        });

        $("#customFileUploadFI2").change(function () {
            read_image(this, 'viewerFI2');
        });

        $("#customFileUploadFI3").change(function () {
            read_image(this, 'viewerFI3');
        });
    ...
    <script>
        function maintenance_mode() {
            ...
            Swal.fire({
                ...
                text: '{{\App\CPU\Helpers::translate('Be careful before you turn on/off maintenance mode')}}',
                type: 'warning',
    ...
    <script>
        $(document).ready(function () {
            @if(!Helpers::module_permission_check('admin.business-settings.web-config.edit'))
            ...
            $("#phone_verification_on").click(function () {
                ...
                if ($('#email_verification_on').prop("checked") == true) {
                    ...
                    const message = "{{\App\CPU\Helpers::translate('Both Phone & Email verification can not be active at a time')}}";
                    toastr.info(message);
                }
                @else
                call_demo();
