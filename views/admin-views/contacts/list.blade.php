...
@section('title', \App\CPU\Helpers::translate('Contact List'))
@push('css_or_js')
                        ...
                        <div class="row justify-content-between align-items-center flex-grow-1">
                            <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                                <h5 class="d-flex gap-2 align-items-center">
                                    {{\App\CPU\Helpers::translate('Customer Messages table')}}
                                    <span
                                ...
                                <form action="{{ url()->current() }}" method="GET">
                                    <div class="input-group input-group-merge input-group-custom">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control"
                                               placeholder="{{\App\CPU\Helpers::translate('Search_by_Name_or_Mobile_No_or_Email')}}"
                    ...
                    <div class="table-responsive">
                        <table id="datatable"
                            ...
                            <tr>
                                ...
                                <th>{{\App\CPU\Helpers::translate('sender name')}}</th>
                                <th>{{\App\CPU\Helpers::translate('Contact_Info')}}</th>
                                <th>{{\App\CPU\Helpers::translate('Subject')}}</th>
                                <th class="text-center">{{\App\CPU\Helpers::translate('actions')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr style="background: {{$contact->seen==0?'rgba(215,214,214,0.56)':'white'}}">
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            ...
                                            @if(Helpers::module_permission_check('admin.contact.delete'))
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        ...
                        data: {id: id},
                        success: function () {
                            toastr.success('{{\App\CPU\Helpers::translate('Contact_deleted_successfully')}}');
                            location.reload();
                        }
                    });
                }
