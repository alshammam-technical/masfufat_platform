                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <div class="text-center">
                                        <img class="border radius-10 upload-img-view viewer" id="viewer"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                            src="{{asset('public\assets\front-end\img\5:1-placeholder.png')}}" alt="banner image"/>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="name" class="title-color font-weight-medium text-capitalize">{{\App\CPU\Helpers::translate('Upload offers image')}}</label>
                                    <span class="text-info ml-1">( {{\App\CPU\Helpers::translate('ratio')}} 5:1 )</span>
                                    <div class="custom-file text-left">
                                        <input type="file" name="image" id="customFileUpload" class="custom-file-input"
                                            accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label text-capitalize" for="customFileUpload">{{\App\CPU\Helpers::translate('choose_file')}}</label>
                                    </div>
                                </div>
                            </div>
                        </div>
