...
@section('title',\App\CPU\Helpers::translate('deliverymen Chatting_List'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('deliverymen Chatting_List')}}
            </h2>
        </div>
        <!-- End Page Title -->
                    ...
                    <div class="card card-body px-0 h-100">
                        <div class="media align-items-center px-3 gap-3 mb-4">
                            ...
                            <div class="media-body">
                                ...
                                <span class="fz-12">{{\App\CPU\Helpers::translate('super_admin')}}</span>
                            </div>
                        </div>
                            ...
                            <form class="search-form px-3" id="chat-search-form">
                                <div class="search-input-group">
                                    ...
                                    <input
                                        ...
                                        placeholder="{{\App\CPU\Helpers::translate('Search_delivery_man...')}}"
