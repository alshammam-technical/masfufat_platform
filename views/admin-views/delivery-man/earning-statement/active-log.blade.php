                    ...
                    <div class="row align-items-center">
                        <div class="col-md-4 col-lg-6 mb-2 mb-md-0">
                            ...
                            <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                                {{ \App\CPU\Helpers::translate('order_list') }}
                            ...
                            <div class="table-responsive datatable-custom">
                                <table class="table table-hover table-borderless table-thead-bordered table-align-middle card-table text-left">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">{{ \App\CPU\Helpers::translate('current_status') }}</th>
                                        <th>{{ \App\CPU\Helpers::translate('history') }}</th>
                                    </tr>
                                    </thead>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <div class="text-center p-4">
                                                    ...
                                                    <p class="mb-0">{{ \App\CPU\Helpers::translate('no_order_history_found') }}</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
