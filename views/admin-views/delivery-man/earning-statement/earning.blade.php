                ...
                <div class="row g-2">
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            <h5 class="business-analytics__subtitle">{{ \App\CPU\Helpers::translate('total_earning') }}</h5>
                            <h2 class="business-analytics__title">{{ $total_earn ? \App\CPU\BackEndHelper::set_symbol(($total_earn)) : \App\CPU\BackEndHelper::set_symbol(0) }}</h2>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            <h5 class="business-analytics__subtitle">{{ \App\CPU\Helpers::translate('withdrawable_balance') }}</h5>
                            <h2 class="business-analytics__title">{{ $withdrawable_balance <= 0 ? \App\CPU\BackEndHelper::set_symbol(0) : \App\CPU\BackEndHelper::set_symbol(($withdrawable_balance)) }}</h2>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        ...
                        <div class="business-analytics">
                            <h5 class="business-analytics__subtitle">{{ \App\CPU\Helpers::translate('withdrawn') }}</h5>
                            <h2 class="business-analytics__title">{{ $delivery_man->wallet? \App\CPU\BackEndHelper::set_symbol(($delivery_man->wallet->total_withdraw)) : \App\CPU\BackEndHelper::set_symbol(0) }}</h2>
                            ...
                            <div class="d-flex align-items-center justify-content-md-end flex-wrap flex-sm-nowrap gap-2">
                                ...
                                <form action="" method="GET">
                                    <div class="input-group input-group-merge input-group-custom">
                                        ...
                                        <input id="datatableSearch_" type="search" name="search" class="form-control" placeholder="{{ \App\CPU\Helpers::translate('Search_by_order_no') }}" aria-label="Search orders" value="{{ $search }}">
                            ...
                            <div class="table-responsive datatable-custom">
                                <table class="table table-hover table-borderless table-thead-bordered table-align-middle card-table text-left">
                                    ...
                                    <tr>
                                        ...
                                        <th>{{ \App\CPU\Helpers::translate('order_no') }}</th>
                                        <th>{{ \App\CPU\Helpers::translate('earning') }}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="media align-items-center gap-10 flex-wrap">
                                                <a class="title-color" title="{{\App\CPU\Helpers::translate('order_details')}}"
                                        ...
                                        <td>
                                            <div class="d-flex flex-column gap-1">
                                                <div class="media-body">{{ \App\CPU\BackEndHelper::set_symbol(($order->deliveryman_charge)) }}</div>
                                        ...
                                        <tr>
                                            <td colspan="4">
                                                <div class="text-center p-4">
                                                    ...
                                                    <p class="mb-0">{{ \App\CPU\Helpers::translate('no_earning_history_found') }}</p>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforelse
