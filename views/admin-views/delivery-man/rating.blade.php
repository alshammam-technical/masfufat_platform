...
@section('title', \App\CPU\Helpers::translate('Delivery-Man Review'))
    ...
    <div class="content container-fluid"
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-10 mb-3">
            ...
            <div class="d-flex justify-content-end flex-wrap gap-10">
                <a href="{{url()->previous()}}" class="btn btn--primary btn-primary">
                    <i class="tio-back-ui"></i> {{\App\CPU\Helpers::translate('Back')}}
                </a>
            </div>
        </div>
                ...
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-auto mb-3 mb-md-0">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-block">
                                ...
                                <p> {{\App\CPU\Helpers::translate('of')}} {{$reviews->count()?? 0}} {{\App\CPU\Helpers::translate('reviews')}}
                                    <span
                    ...
                    <div class="col-md">
                        <ul class="list-unstyled list-unstyled-py-2 mb-0">
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{\App\CPU\Helpers::translate('4 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{\App\CPU\Helpers::translate('3 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{\App\CPU\Helpers::translate('2 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
                            ...
                            <li class="d-flex align-items-center font-size-sm">
                                <span
                                    class="{{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">{{\App\CPU\Helpers::translate('1 star')}}</span>
                                <div class="progress flex-grow-1">
                                    <div class="progress-bar" role="progressbar"
        ...
        <div class="card card-body mt-3">
                    ...
                    <form action="{{ url()->current() }}" method="GET">
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                   placeholder="{{ \App\CPU\Helpers::translate('Search by Order ID') }}"
            ...
            <form action="{{ url()->current() }}" method="GET">
                <div class="row gy-3 align-items-end">
                    ...
                    <div class="col-md-3">
                        <div>
                            <label for="to_date" class="title-color d-flex">{{ \App\CPU\Helpers::translate('to') }}</label>
                        ...
                        <div>
                            <select class="form-control" name="rating">
                                <option value="" selected>
                                    --{{ \App\CPU\Helpers::translate('Select_Rating') }}--
                                </option>
                                <option
                                    value="1" {{ $rating==1 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('1') }}</option>
                                <option
                                    value="2" {{ $rating==2 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('2') }}</option>
                                <option
                                    value="3" {{ $rating==3 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('3') }}</option>
                                <option
                                    value="4" {{ $rating==4 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('4') }}</option>
                                <option
                                    value="5" {{ $rating==5 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('5') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2">
                                ...
                                <div class="text-wrap">
                                    ...
                                    <div class="content p-0">
                                        @if(strlen($review['comment']) > 200))
                                            ...
                                            <span id="show-more-{{$review->id}}" data-id="{{$review->id}}" onclick="toggle_btn(this)">...<a href="javascript:void(0)">{{ \App\CPU\Helpers::translate('show_more') }}</a></span>

                                            <span id="show-more-content-{{$review->id}}" class="show-more-content">
                                            {{substr($review['comment'], 200)}}
                                            <span id="show-less-{{$review->id}}" data-id="{{$review->id}}" onclick="toggle_btn(this)"><a href="javascript:void(0)">{{ \App\CPU\Helpers::translate('show_less') }}</a></span>
                                        @else
                                            {{ $review['comment'] }}
                                        @endif
                                    </div>
