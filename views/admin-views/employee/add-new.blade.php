...
@section('title', \App\CPU\Helpers::translate('Employee Add'))
@push('css_or_js')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="name"
                                               class="title-color">{{\App\CPU\Helpers::translate('Full Name')}}</label>
                                        <input type="text" name="name" class="form-control" id="name"
                                               placeholder="{{\App\CPU\Helpers::translate('Ex')}} : {{\App\CPU\Helpers::translate('Md. Al Imrun')}}"
                                               value="{{old('name')}}" required>
                                    </div>
                                    <div class="form-control " dir="ltr">
                                        <input class="phoneInput text-left border-0 w-100" dir="ltr" type="text" name="phone" id="phone"
                                        style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                        value="{{old('phone') ?? '+966'}}"
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="title-color">{{\App\CPU\Helpers::translate('Role')}}</label>
                                        <select class="form-control" name="role_id">
                                            <option value="0" selected disabled>---{{\App\CPU\Helpers::translate('select')}}---
                                            </option>
                                            @foreach($rls as $r)
                                                <option
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="name"
                                               class="title-color">{{\App\CPU\Helpers::translate('employee_image')}}</label>
                                        ...
                                        <div class="form-group">
                                            <div class="custom-file text-left">
                                                ...
                                                <label class="custom-file-label"
                                                       for="customFileUpload">{{\App\CPU\Helpers::translate('choose file')}}</label>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="name" class="title-color">{{\App\CPU\Helpers::translate('Email')}}</label>
                                        <input type="email" name="email" value="{{old('email')}}" class="form-control"
                                               id="email"
                                               placeholder="{{\App\CPU\Helpers::translate('Ex')}} : ex@gmail.com" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="password"
                                               class="title-color">{{\App\CPU\Helpers::translate('password')}}</label>
                                        <input type="text" name="password" class="form-control" id="password"
                                               placeholder="{{\App\CPU\Helpers::translate('Password')}}" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="confirm_password"
                                               class="title-color">{{\App\CPU\Helpers::translate('confirm_password')}}</label>
                                        <input type="text" name="confirm_password" class="form-control"
                                               id="confirm_password"
                                               placeholder="{{\App\CPU\Helpers::translate('Confirm Password')}}" required>
                                    </div>
                                </div>
                            </div>
