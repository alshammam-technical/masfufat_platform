...
@section('title', \App\CPU\Helpers::translate('Employee Edit'))
@push('css_or_js')
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">{{\App\CPU\Helpers::translate('Employee Update form')}}</h5>
                </div>
                <div class="card-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    <label for="name" class="title-color">{{\App\CPU\Helpers::translate('Name')}}</label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="email" class="title-color">{{\App\CPU\Helpers::translate('Email')}}</label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label class="title-color">{{\App\CPU\Helpers::translate('Role')}}</label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="password" class="title-color">{{\App\CPU\Helpers::translate('Password')}}</label><small> ( {{\App\CPU\Helpers::translate('input if you want to change')}} )</small>
                                    <input type="text" name="password" class="form-control" id="password"
                                           placeholder="{{\App\CPU\Helpers::translate('Password')}}">
                                </div>
                                <div class="col-md-6 form-group">
                                    <div class="form-group">
                                        <label for="customFileUpload" class="title-color">{{\App\CPU\Helpers::translate('employee_image')}}</label>
                                        <span class="text-danger">( {{\App\CPU\Helpers::translate('ratio')}} 1:1 )</span>
