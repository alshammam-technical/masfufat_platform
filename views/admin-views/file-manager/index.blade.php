...
@section('title',\App\CPU\Helpers::translate('gallery'))
@push('css_or_js')
    ...
    <div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 24%">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('file_manager')}}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            <h5 class="mb-0">{{\App\CPU\Helpers::translate('file_manager')}}</h5>
            <button type="button" class="btn btn--primary btn-primary modalTrigger" data-toggle="modal" data-target="#exampleModal">
                <i class="tio-add"></i>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn--primary btn-primary" href="{{url()->previous()}}">
                            <i class="tio-chevron-left"></i>
                            {{\App\CPU\Helpers::translate('back')}}
                        </a>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <button type="button" class="close" data-dismiss="modal"><span
                                                                ...
                                                                class="sr-only">{{\App\CPU\Helpers::translate('close')}}</span>
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div class="modal-footer">
                                                        <a class="btn btn--primary btn-primary"
                                                           href="{{route('admin.file-manager.download', base64_encode($file['path']))}}"><i
                                                                class="tio-download"></i> {{\App\CPU\Helpers::translate('download')}}
                                                        </a>
                                                        <button class="btn btn-info"
                                                                onclick="copy_test('{{$file['db_path']}}')"><i
                                                                class="tio-copy"></i> {{\App\CPU\Helpers::translate('copy_path')}}
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="exampleModalLabel">{{\App\CPU\Helpers::translate('upload file')}} </h5>
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label"
                                           for="customFileUpload">{{\App\CPU\Helpers::translate('choose images')}}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" id="zipFileLabel"
                                           for="customZipFileUpload">{{\App\CPU\Helpers::translate('upload_zip_file')}}</label>
                                </div>
                            </div>

                            <div class="row" id="files"></div>
                            <div class="form-group">
                                <input class="btn btn--primary btn-primary" type="{{env('APP_MODE')!='demo'?'submit':'button'}}"
                                       onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}"
                                       value="{{\App\CPU\Helpers::translate('upload')}}">
                            </div>
                        </form>
...
@push('script_2')
    <script>
        ...
        function copy_test(copyText) {
            ...
            toastr.success('{{\App\CPU\Helpers::translate('file_path_copied_successfully!')}}', {
                CloseButton: true,
                ProgressBar: true
            });
        }
