...
@section('title', \App\CPU\Helpers::translate('Update mail'))
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a href="{{ route('admin.mail.add-new') }}">
                                {{Helpers::translate('push_mail')}}
                            </a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">
                            <a>
                                {{Helpers::translate('push_mail_update')}}
                            </a>
                        </li>
                    </ol>
                </nav>
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.mail.update',[$mail['id']])}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$mail['title']}}" name="title" class="form-control"
                                       placeholder="{{\App\CPU\Helpers::translate('New mail')}}" required>
                            </div>
                            <div class="form-group">
                                <label class="input-label" for="exampleFormControlInput1">{{\App\CPU\Helpers::translate('Description')}}</label>
                                <textarea name="description" class="form-control"
                                          required>{{$mail['description']}}</textarea>
                            </div>
                            <div class="form-group text-left">
                                ...
                                <center>
                                    <img class="upload-img-view mt-4"
                                        ...
                                        src="{{asset('storage/app/public/mail')}}/{{$mail['image']}}"
                                         alt="image"/>
                                </center>
                            </div>
