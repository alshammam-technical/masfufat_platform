...
<div class="d-print-none w-100 text-center mt-5 action-btns">
...
<div style="width:100%" class="bg-white a-layout" style="display: none">
...
<div style="width:410px" class="bg-white roll-layout">
    <div class="mb-3 border border-dark p-2 bg-white" style="border-radius: 11px">
