                                    ...
                                    <div class="order-status d-flex justify-content-sm-end gap-10 text-capitalize">
                                        ...
                                        @if($order['order_status']=='pending')
                                            <span class="badge badge-soft-info font-weight-bold radius-50 d-flex align-items-center py-1 px-2">
                                                {{\App\CPU\Helpers::translate(str_replace('_',' ',$order['order_status']))}}
                                            </span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="media align-items-center gap-10">
                                                    ...
                                                    <img src="{{asset("storage/app/public/product/$current_lang")}}/{{(isset(json_decode($product['images'])->$current_lang)) ? json_decode($product['images'])->$current_lang[0] ?? '' : ''}}" onerror="this.src='{{asset('public/assets/back-end/img/160x160/img2.jpg')}}'" class="avatar avatar-60 rounded" alt="">
                            ...
                            <div class="media flex-wrap gap-3">
                                ...
                                <div class="media-body d-flex flex-column gap-1">
                                    ...
                                    <span class="title-color">
                                        <strong>{{\App\Model\Order::where('order_type','POS')->where('customer_id',$order['customer_id'])->count()}} </strong>{{\App\CPU\Helpers::translate('orders')}}
                                    </span>
