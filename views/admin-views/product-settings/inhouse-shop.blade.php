    ...
    <div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 24%">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('In-House_Shop')}}
            </h2>
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0 d-flex gap-2 flex-wrap">
                                ...
                                {{\App\CPU\Helpers::translate('Shop_cover_Image')}}
                            </h5>
                        </div>
                        <div class="card-body">
                            {{--    --}}
                            ...
                            <div class="form-group {{$lang != ($default_lang ?? session()->get('local')) ? 'd-none':''}} lang_form mt-3"
                                ...
                                <center>
                                    <img id="viewerShop" width="300" class="viewer"
                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                    src="{{asset('storage/app/public/shop')}}/{{\App\CPU\Helpers::get_business_settings('shop_banner')[$lang] ?? ''}}">
                                </center>
                                ...
                                <div class="d-flex justify-content-end mt-30" hidden>
                                    <button type="submit" class="btn btn--primary btn-primary px-4 btn-save" hidden>{{\App\CPU\Helpers::translate('Upload')}}</button>
                                </div>
