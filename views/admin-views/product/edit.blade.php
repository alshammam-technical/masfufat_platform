    ...
    <div class="content container-fluid">
        ...
        <div class="d-flex justify-content-sm-start flex-wrap gap-2 mb-3">
            <div>
                ...
                @if(Helpers::module_permission_check('admin.products.seller.'.$product['request_status'].'.enable'))
            ...
            <div>
                ...
                @else
                    @if(Helpers::module_permission_check('admin.products.seller.'.$product['request_status'].'.disable'))
                                            ...
                                            <div class="py-2 px-0 row w-100 mx-0">
                                                <div class="col-lg-12 p-0" style="overflow-y: auto;height: 1070px;">
                                                    ...
                                                    <div class="input-group mb-2  p-2">
                                                        ...
                                                        <div class="form-control p-0 mb-0 linked_products_input_on linked_products_input"
                                                        @if (!$product->linked_products) style="display: none" @endif>
                                                            <select name="linked_products_ids" multiple="multiple" aria-describedby="basic-addon1" value="" class="SumoSelect-noImg" placeholder="{{\App\CPU\Helpers::translate('Linked Products')}}" type="text">
                                                                @foreach (Helpers::getProducts() as $c)
                                                                <option
                                                                @if(in_array($c->id,explode(',',$product->linked_products_ids)))
                                                                selected
                                                                @endif
                                                                icon ="{{asset($c->photo)}}"
                                                        ...
                                                        <input type="hidden" name="linked_products_ids" value="{{$product->linked_products_ids}}" />
                                                    </div>
