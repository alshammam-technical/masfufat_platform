...
<table class="table table-bordered physical_product_show">
    ...
    <tr>
        <td class="text-center">
            <label for="" class="title-color">{{\App\CPU\Helpers::translate('Variant')}}</label>
        </td>
        <td class="text-center">
            <label for="" class="title-color">{{\App\CPU\Helpers::translate('Variant Price')}}</label>
        </td>
        <td class="text-center">
            <label for="" class="title-color">{{\App\CPU\Helpers::translate('SKU')}}</label>
        </td>
        <td class="text-center">
            <label for="" class="title-color">{{\App\CPU\Helpers::translate('Quantity')}}</label>
        </td>
    </tr>
    </thead>
    <tbody>
