		...
		<thead>
			<tr>
				<td class="text-center">
					<label for="" class="control-label">{{\App\CPU\Helpers::translate('Variant')}}</label>
				</td>
				<td class="text-center">
					<label for="" class="control-label">{{\App\CPU\Helpers::translate('Variant Price')}}</label>
				</td>
				<td class="text-center">
					<label for="" class="control-label">{{\App\CPU\Helpers::translate('SKU')}}</label>
				</td>
				<td class="text-center">
					<label for="" class="control-label">{{\App\CPU\Helpers::translate('Quantity')}}</label>
				</td>
			</tr>
		</thead>
		<tbody>
