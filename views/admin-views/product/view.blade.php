...
@section('title', \App\CPU\Helpers::translate('Product Preview'))
    ...
    <div class="content container-fluid"
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-10 mb-3">
            ...
            <div class="d-flex justify-content-end flex-wrap gap-10">
                ...
                <a href="{{route('product',$product['slug'])}}" class="btn btn--primary btn-primary " target="_blank"><i
                        class="tio-globe"></i> {{ \App\CPU\Helpers::translate('View') }} {{ \App\CPU\Helpers::translate('from') }} {{ \App\CPU\Helpers::translate('Website') }}
                </a>
            </div>
        </div>
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="width-100"
                                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                    src="{{asset("storage/app/public/product/$photo[0] ?? ''")}}" alt="Product image">
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
