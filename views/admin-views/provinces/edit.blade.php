...
<div class="content container-fluid">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    <form action="{{route('admin.provinces.update',$b['id'])}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @php
                            ...
                            <div class="col-md-6">
                                @foreach(Helpers::get_langs() as $i=>$lang)
                                    <div class="form-group {{$lang != $default_lang ? 'd-none':''}} lang_form"
                                        ...
                                        value="{{ \App\CPU\Helpers::get_prop('App\provinces',$b['id'],'name',$lang) }}"
    ...
    <!--modal-->
    @include('shared-partials.image-process._image-crop-modal',['modal_id'=>'province-image-modal','width'=>1000,'margin_left'=>'-53%'])
    <!--modal-->
</div>
@endsection
