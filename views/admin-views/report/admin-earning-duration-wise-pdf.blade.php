        ...
        <table class="bs-0 mb-30 px-10">
            <tr>
                <th class="content-position-y text-left">
                    <h2>{{\Helpers::translate('Admin_Earning_Report')}}</h2>
                    <p class="fz-14">{{\Helpers::translate('date')}} : <span style="font-weight: normal">{{ date('d/m/Y') }}</span></p>
                </th>
                ...
                <tr>
                    <td class="p-1">
                        <table>
                            <tr>
                                <td>
                                    <p class="fz-14"><b>{{\Helpers::translate('duration')}}</b> : {{ $earning_data['duration'] }} </p>
                                </td>
                            </tr>
                        </table>
                    </td>
        ...
        <div class="content-position-y">
            <table class="customers bs-0">
                <tbody>
                    ...
                    <tr>
                        <td>1</td>
                        <td>{{\Helpers::translate('In-House_earning')}}</td>
                    ...
                    <tr>
                        <td>2</td>
                        <td>{{\Helpers::translate('Admin_Commission')}}</td>
                    ...
                    <tr>
                        <td colspan="2" class="text-right">
                            <b>{{\Helpers::translate('Total_Earning')}}</b>
                        </td>
