    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\Helpers::translate('Earning_Report')}}
            </h2>
        </div>
        <!-- End Page Title -->
                    ...
                    <div class="media-body">
                        <div class="row align-items-center">
                            <div class="d-block col-sm mb-1 mb-sm-0 {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}}" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                <div>
                                    <h1 class="page-header-title">{{\Helpers::translate('Earning Report Overview')}} </h1>
                                </div>

                                <div class="row align-items-center">
                                    <div class="flex-between col-auto">
                                        <h5 class="text-muted {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}">{{\Helpers::translate('Admin')}} : </h5>
                                        <h5 class="text-muted">{{auth('admin')->user()->name}}</h5>
                                    </div>

                                    <div class="col-auto">
                                        <div class="row align-items-center g-0">
                                            <h5 class="text-muted col-auto {{Session::get('direction') === "rtl" ? 'pl-2' : 'pr-2'}}">{{\Helpers::translate('Date')}}</h5>
                        ...
                        <form action="{{route('admin.report.set-date')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-12 mb-2">
                                    <label class="title-color d-flex">{{\Helpers::translate('show_data_by_date_range')}}</label>
                                </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn--primary btn-block">{{\Helpers::translate('Show')}}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
                            ...
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                                        <h4 class="mb-1">{{\Helpers::translate('Total earning')}} </h4>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                                        <h4 class="mb-1">{{\Helpers::translate('Total Tax')}} </h4>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body {{Session::get('direction') === "rtl" ? 'text-right' : 'text-left'}}">
                                        <h4 class="mb-1">{{\Helpers::translate('Total commission')}} </h4>
        ...
        <div class="card mb-3 mb-lg-5 border-top border-left border-right border-bottom">
            ...
            <div class="card-header flex-wrap">
                ...
                <div class="flex-start">
                    <h6 class="card-subtitle mt-1">{{\Helpers::translate('total_sale_of')}} {{date('Y')}} :</h6>
                ...
                <div class="hs-unfold">
                    <a class="js-hs-unfold-invoker btn btn-white"
                       href="{{route('admin.orders.list',['all'])}}">
                        <i class="tio-shopping-cart-outlined {{Session::get('direction') === "rtl" ? 'ml-1' : 'mr-1'}}"></i> {{\Helpers::translate('Orders')}}
                    </a>
                </div>
                <!-- End Unfold -->
            </div>
