...
@section('title', \Helpers::translate('Inhouse product sale Report'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\Helpers::translate('inhouse_sale')}}
            </h2>
        </div>
        <!-- End Page Title -->
                            ...
                            <div class="row gy-2 align-items-center">
                                <div class="col-sm-9">
                                    <div class="d-flex align-items-center gap-10">
                                        <label for="exampleInputEmail1" class="title-color mb-0">{{\Helpers::translate('Category')}}</label>
                                        <select
