...
@section('title', \Helpers::translate('Order Report'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\Helpers::translate('Order_Report')}}
            </h2>
        </div>
        <!-- End Page Title -->
                    ...
                    <div class="row gx-2 gy-3 align-items-center text-left">
                        <div class="col-sm-6 col-md-3">
                            <select class="js-select2-custom form-control text-ellipsis" name="seller_id">
                                <option value="all" {{ $seller_id == 'all' ? 'selected' : '' }}>{{\Helpers::translate('all')}}</option>
                                <option value="inhouse" {{ $seller_id == 'inhouse' ? 'selected' : '' }}>{{\Helpers::translate('In-House')}}</option>
        ...
        <div class="store-report-content mb-2">
            <div class="left-content">
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{\Helpers::translate('Total_Orders')}}</h6>
                    </div>
                    <div class="coupon__discount w-100 text-right d-flex justify-content-between">
                        <div class="text-center">
                            <strong class="text-danger">{{ $order_count['canceled_order'] }}</strong>
                            <div class="d-flex">
                                <span>{{\Helpers::translate('canceled orders')}}</span>
                                <span class="mx-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('this_count_is_the_summation_of')}} {{\Helpers::translate('failed_to_deliver')}}, {{\Helpers::translate('canceled')}}, {{\Helpers::translate('and')}} {{\Helpers::translate('returned_orders')}}">
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                <span>{{\Helpers::translate('ongoing orders')}}</span>
                                <span class="mx-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('this_count_is_the_summation_of')}} {{\Helpers::translate('pending')}}, {{\Helpers::translate('confirmed')}}, {{\Helpers::translate('packaging')}}, {{\Helpers::translate('out_for_delivery_orders')}}">
                                    <img class="info-img" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="img">
                                </span>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                <span>{{\Helpers::translate('completed orders')}}</span>
                                <span class="mx-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('this_count_is_the_summation_of_delivered_orders')}}">
                                    <img class="info-img" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="img">
                                </span>
                            </div>
                        </div>
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{\Helpers::translate('Total_Order_Amount')}}</h6>
                    </div>
                    <div class="coupon__discount w-100 text-right d-flex justify-content-between">
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                <span>{{\Helpers::translate('Due_Amount')}}</span>
                                <span class="trx-y-2 ml-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('the_ongoing_order_amount_will_be_shown_here')}}">
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                <span>{{\Helpers::translate('Already_Settled')}}</span>
                                <span class="trx-y-2 ml-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('after_the_order_is_delivered_total_order_amount_will_be_shown_here')}}">
                                    <img src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="img">
                                </span>
                            </div>
                        </div>
            ...
            <div class="center-chart-area">
                <div class="center-chart-header">
                    <h3 class="title">{{\Helpers::translate('Order_Statistics')}}</h3>
                </div>
                ...
                "data": {
                  ...
                  "datasets": [{
                    "label": "{{\Helpers::translate('total_settled_amount')}}",
            ...
            <div class="right-content">
                ...
                <div class="card h-100 bg-white payment-statistics-shadow">
                    <div class="card-header border-0 ">
                        <h5 class="card-title">
                            <span>{{\Helpers::translate('Payment_Statistics')}}</span>
                        </h5>
                    </div>
                    <div class="card-body px-0 pt-0">
                        <div class="position-relative pie-chart">
                            ...
                            <div class="total--orders">
                                ...
                                <span>{{\Helpers::translate('completed')}} <br> {{\Helpers::translate('payments')}}</span>
                            </div>
                            <!-- Total Orders -->
                        </div>
                        <div class="apex-legends">
                            ...
                            <div class="before-bg-CDE6F5">
                                <span>{{\Helpers::translate('offline_payments')}} ({{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payment_data['offline_payment'])) }})</span>
                            </div>
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex flex-wrap w-100 gap-3 align-items-center">
                    <h4 class="mb-0 {{ (session('direction') == 'ltr') ? 'mr' : 'ml' }}-auto">
                        {{\Helpers::translate('Total_Orders')}}
                        <span class="badge badge-soft-dark radius-50 fz-14">{{ $orders->total() }}</span>
                    </h4>
                    <form action="" method="GET" class="mb-0" style="width: 326px">
                        <!-- Search -->
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" value="{{ $search }}" type="search" name="search" class="form-control" placeholder="{{ \Helpers::translate('search_by_order_id')}}" aria-label="Search orders" required>
            ...
            <div class="table-responsive">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{\Helpers::translate('Order ID')}}</th>
                        <th>{{\Helpers::translate('Total Amount')}}</th>
                        <th>{{\Helpers::translate('Product Discount')}}</th>
                        <th>{{\Helpers::translate('Coupon Discount')}}</th>
                        <th>{{\Helpers::translate('Shipping Charge')}}</th>
                        <th>{{\Helpers::translate('VAT/TAX')}}</th>
                        <th>{{\Helpers::translate('Commission')}}</th>
                        <th class="text-center">{{\Helpers::translate('Status')}}</th>
                    </tr>
                    </thead>
                    <tbody>
                                ...
                                <div class="d-flex justify-content-center">
                                    ...
                                    @elseif($order['order_status']=='processing' || $order['order_status']=='out_for_delivery')
                                        <span class="badge badge-soft-warning fz-12">
                                            {{str_replace('_',' ',($order['order_status'] == 'processing') ? \Helpers::translate('packaging'):\Helpers::translate($order['order_status']))}}
                                        </span>
                                    ...
                                    @elseif($order['order_status']=='failed')
                                        <span class="badge badge-danger fz-12">
                                            {{\Helpers::translate('failed_to_deliver')}}
                                        </span>
                        ...
                        <tr>
                            <td colspan="9">
                                <div class="text-center p-4">
                                    ...
                                    <p class="mb-0">{{ \Helpers::translate('No_data_to_found')}}</p>
                                </div>
                            </td>
                        </tr>
                    @endif
    ...
    <script>
        var options = {
            ...
            labels: [
                ...
                '{{\Helpers::translate('Offline_Payments')}} ({{ \App\CPU\BackEndHelper::currency_symbol() }}{{ \App\CPU\BackEndHelper::format_currency(\App\CPU\BackEndHelper::usd_to_currency($payment_data['offline_payment'])) }})',
