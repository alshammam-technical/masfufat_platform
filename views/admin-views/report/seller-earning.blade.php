            ...
            <div class="left-content">
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{ \Helpers::translate('Total_Seller')}}</h6>
                    </div>
                </div>
                <div class="left-content-card">
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{ \Helpers::translate('Total_Earning')}}</h6>
                    </div>
                </div>
            </div>
            <div class="center-chart-area">
                <div class="center-chart-header">
                    <h3 class="title">{{ \Helpers::translate('Earning_Statistics') }}</h3>
                    <h5 class="subtitle d-flex">
                        <span>{{ \Helpers::translate('Average_Earning_Value') }} :</span>
                ...
                "data": {
                  ...
                  "datasets": [{
                     "label": "{{\Helpers::translate('Total_Earnings')}}",
            ...
            <div class="right-content">
                ...
                <div class="card h-100 bg-white payment-statistics-shadow">
                    <div class="card-header border-0 ">
                        <h5 class="card-title">
                            <span>{{ \Helpers::translate('Seller portfolio statistics')}}</span>
                        </h5>
                    </div>
                    <div class="card-body px-0 pt-0">
                        <div class="position-relative pie-chart">
                            ...
                            <div class="total--orders">
                                ...
                                <span>{{ \Helpers::translate('Wallet Amount')}}</span>
                            </div>
                            <!-- Total Orders -->
                        </div>
                        <div class="apex-legends">
                            <div class="before-bg-004188">
                                <span>{{\Helpers::translate('Withdrawble Balance')}} ({{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payment_data['withdrawable_balance'])) }})</span>
                            </div>
                            <div class="before-bg-0177CD">
                                <span>{{\Helpers::translate('Pending Withdraws')}} ({{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payment_data['pending_withdraw'])) }})</span>
                            </div>
                            <div class="before-bg-A2CEEE">
                                <span>{{\Helpers::translate('Successfully withdrawn balance from wallet')}} ({{ \App\CPU\BackEndHelper::set_symbol(\App\CPU\BackEndHelper::usd_to_currency($payment_data['already_withdrawn'])) }})</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{\Helpers::translate('Seller_Info')}}</th>
                        <th>{{\Helpers::translate('Earn_From_Order')}}</th>
                        <th>{{\Helpers::translate('Earn_From_Shipping')}}</th>
                        <th>{{\Helpers::translate('Commission_Given')}}</th>
                        <th>{{\Helpers::translate('Discount_Given')}}</th>
                        <th>{{\Helpers::translate('Tax_Collected')}}</th>
                        <th>{{\Helpers::translate('Refund_Given')}}</th>
                        <th>{{\Helpers::translate('Total_Earning')}}</th>
                    </tr>
                    </thead>
...
<!-- Chart JS -->
    ...
    <script>
        var options = {
            ...
            labels: [
                '{{\Helpers::translate('Withdrawble_Balance')}} ({{ \App\CPU\BackEndHelper::currency_symbol() }}{{ \App\CPU\BackEndHelper::format_currency(\App\CPU\BackEndHelper::usd_to_currency($payment_data['withdrawable_balance'])) }})',
                '{{\Helpers::translate('Pending_Withdraws')}} ({{ \App\CPU\BackEndHelper::currency_symbol() }}{{ \App\CPU\BackEndHelper::format_currency(\App\CPU\BackEndHelper::usd_to_currency($payment_data['pending_withdraw'])) }})',
                '{{\Helpers::translate('Successfully withdrawn balance from wallet')}} ({{ \App\CPU\BackEndHelper::currency_symbol() }}{{ \App\CPU\BackEndHelper::format_currency(\App\CPU\BackEndHelper::usd_to_currency($payment_data['already_withdrawn'])) }})'
            ],
            dataLabels: {
                enabled: false,
                style: {
