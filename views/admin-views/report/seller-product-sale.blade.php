...
@section('title', \Helpers::translate('Seller product sale Report'))
    ...
    <div class="content container-fluid">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\Helpers::translate('Seller Reports')}}
            </h2>
        </div>
        <!-- End Page Title -->
                    ...
                    <div class="row gx-2 gy-3 align-items-center text-left">
                        <div class="col-sm-6 col-md-3">
                            <select class="js-select2-custom form-control" name="seller_id">
                                <option value="all">{{\Helpers::translate('all_sellers')}}</option>
                        ...
                        <div class="col-sm-6 col-md-3">
                            <select class="form-control __form-control" name="date_type" id="date_type">
                                <option value="this_year" {{ ($date_type ?? null) == 'this_year'? 'selected' : '' }}>{{\Helpers::translate('This_Year')}}</option>
                                <option value="this_month" {{ ($date_type ?? null) == 'this_month'? 'selected' : '' }}>{{\Helpers::translate('This_Month')}}</option>
                                <option value="this_week" {{ ($date_type ?? null) == 'this_week'? 'selected' : '' }}>{{\Helpers::translate('This_Week')}}</option>
                                <option value="custom_date" {{ ($date_type ?? null) == 'custom_date'? 'selected' : '' }}>{{\Helpers::translate('Custom_Date')}}</option>
                            </select>
                        </div>
                        <div class="col-sm-6 col-md-3" id="from_div">
                            <div class="form-floating">
                                <input type="date" name="from" value="{{$from ?? null}}" id="from_date" class="form-control">
                                <label>{{\Helpers::translate('start_date')}}</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3" id="to_div">
                            <div class="form-floating">
                                <input type="date" value="{{$to ?? null}}" name="to" id="to_date" class="form-control">
            ...
            <div class="left-content">
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{\Helpers::translate('products')}}</h6>
                    </div>
                </div>
                <div class="left-content-card">
                    ...
                    <div class="coupon__discount w-100 text-right d-flex justify-content-between">
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                <span>{{\Helpers::translate('canceled')}}</span>
                                <span class="ml-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('this_count_is_the_summation_of')}} {{\Helpers::translate('failed_to_deliver')}}, {{\Helpers::translate('canceled')}}, {{\Helpers::translate('and')}} {{\Helpers::translate('returned_orders')}}">
                        ...
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                <span>{{\Helpers::translate('ongoing')}}</span>
                                <span class="ml-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('this_count_is_the_summation_of')}} {{\Helpers::translate('pending')}}, {{\Helpers::translate('confirmed')}}, {{\Helpers::translate('packaging')}}, {{\Helpers::translate('out_for_delivery_orders')}}">
                                    <img class="info-img" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="img">
                                </span>
                            </div>
                        </div>
                        <div class="text-center">
                            ...
                            <div class="d-flex">
                                <span>{{\Helpers::translate('completed')}}</span>
                                <span class="ml-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('this_count_is_the_summation_of_delivered_orders')}}">
                                    <img class="info-img" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="img">
                                </span>
                            </div>
                        </div>
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{\Helpers::translate('Total_Deliveryman')}}</h6>
                    </div>
                </div>
            </div>
                ...
                <div class="card h-100 bg-white payment-statistics-shadow">
                    <div class="card-body d-flex flex-column justify-content-center">
                        <div class="earning-statistics-content">
                            ...
                            <h6 class="subtitle">{{\Helpers::translate('Total_Shop_Earnings')}}</h6>
                            <h3 class="title">
            ...
            <div class="card-header border-0">
                <div class="d-flex flex-wrap w-100 gap-3 align-items-center">
                    <h4 class="mb-0 {{ (session('direction') == 'ltr') ? 'mr' : 'ml' }}-auto">
                        {{\Helpers::translate('Total_Seller')}}
                    ...
                    <form action="{{ url()->full() }}" method="GET" class="mb-0">
                        ...
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" type="search" value="{{ $search }}" name="search" class="form-control" placeholder="{{Helpers::translate('Search by seller')}}" aria-label="Search orders" required="">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a class="dropdown-item"
                                   href="{{ route('admin.report.seller-report-excel', ['date_type'=>request('date_type'), 'seller_id'=>request('seller_id'),'from'=>request('from'), 'to'=>request('to'), 'search'=>request('search')]) }}"  >{{\Helpers::translate('Excel')}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table id="datatable"
                        ...
                        <tr>
                            ...
                            <th>{{\Helpers::translate('Seller Info')}}</th>
                            <th>{{\Helpers::translate('Total Order')}}</th>
                            <th>{{\Helpers::translate('Commission')}}</th>
                            <th class="text-center">{{\Helpers::translate('Refund Rate')}}</th>
