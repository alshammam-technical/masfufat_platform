...
<html>
  <head>
    <title>{{ Helpers::translate('Import sellers') }}</title>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    <script>
        ...
        const columns = [
            ...
            {
                "prop": "show_sellers_section",
                "name": "{{Helpers::translate('show on store')}}",
                "editor": "checkbox",
                "size": 300,
            },
            {
                "prop": "vendor_account_number",
                "name": "{{Helpers::translate('Vendor Account number')}}",
                "size": 300,
            },
            {
                "prop": "shop[name]",
                "name": "{{Helpers::translate('company_name')}}",
                "size": 300,
            },
            {
                "prop": "name",
                "name": "{{Helpers::translate('license_owners_name')}}",
                "size": 300,
            },
            {
                "prop": "phone",
                "name": "{{Helpers::translate('license owners phone')}}",
                "size": 300,
            },
            {
                "prop": "email",
                "name": "{{Helpers::translate('Email')}}",
                "size": 300,
            },
            {
                "prop": "password",
                "name": "{{Helpers::translate('Password')}}",
                "size": 300,
            },
            {
                "prop": "delegate_name",
                "name": "{{Helpers::translate('delegates_name')}}",
                "size": 300,
            },
            {
                "prop": "delegate_phone",
                "name": "{{Helpers::translate('delegates_phone')}}",
                "size": 300,
            },
            {
                "prop": "commercial_registration_no",
                "name": "{{Helpers::translate('seller_commercial_registration_no')}}",
                "size": 300,
            },
            {
                "prop": "tax_no",
                "name": "{{Helpers::translate('seller tax number')}}",
                "size": 300,
            },

            {
                "prop": "country",
                "name": "{{Helpers::translate('country')}}",
                "size": 300,
                "editor": 'select',
                "single": 1,
            ...
            {
                "prop": "governorate",
                "name": "{{Helpers::translate('governorate')}}",
                "size": 300,
                "editor": 'select',
                "single": 1,
                "editorSource": [],
            ...
            {
                "prop": "address",
                "name": "{{Helpers::translate('address')}}",
                "size": 300,
                "editor": "textarea",
            },
            {
                "prop": "bank_name",
                "name": "{{Helpers::translate('bank_name') }})",
                "size": 300
            },
            {
                "prop": "branch",
                "name": "{{Helpers::translate('Branch') }})",
                "size": 300
            },
            {
                "prop": "holder_name",
                "name": "{{Helpers::translate('holder_name') }})",
                "size": 300
            },
            {
                "prop": "account_no",
                "name": "{{Helpers::translate('account_no') }})",
                "size": 300
            },

            {
                "prop": "image[]",
                "name": "{{Helpers::translate('Seller logo')}}",
                "editor": "img",
                "size": 300
            },
            {
                "prop": "imageUrl",
                "name": "{{Helpers::translate('Seller logo')}} ({{ Helpers::translate('Url') }})",
                "size": 300
            },
            ...
            {
                "prop": "banner[{{$lang}}]",
                "name": "{{Helpers::translate('Seller Banner').'('.Helpers::translate($lang.' language').')'}}",
                "editor": "img",
                "size": 300
            },
            {
                "prop": "bannerUrl[{{$lang}}]",
                "name": "{{Helpers::translate('Seller Banner').'('.Helpers::translate($lang.' language').')'}} ({{ Helpers::translate('Url') }})",
                "size": 300
            },
            @endforeach

            {
                "prop": "commercial_registration_img[]",
                "name": "{{Helpers::translate('seller_commercial_registration_image')}} {{ Helpers::translate('(attachment)') }}",
                "editor": "file",
                "size": 300
            },
            {
                "prop": "commercial_registration_imgUrl",
                "name": "{{Helpers::translate('seller_commercial_registration_image')}} ({{ Helpers::translate('Url') }})",
                "size": 300
            },

            {
                "prop": "tax_certificate_img[]",
                "name": "{{Helpers::translate('seller_tax_certificate_image')}} {{ Helpers::translate('(attachment)') }}",
                "editor": "file",
                "size": 300
            },
            {
                "prop": "tax_certificate_imgUrl",
                "name": "{{Helpers::translate('seller_tax_certificate_image')}} ({{ Helpers::translate('Url') }})",
                "size": 300
            },
    ...
    <script>
        ...
        async function save(){
            ...
            for (let key = current; key <= (parseInt(source_length) + 1); key++) {
                ...
                current = key;
                var excep = ['image[]','commercial_registration_img[]','tax_certificate_img[]']
                if(item['vendor_account_number']){
                    if(!formData[key]){
                    ...
                    await $.ajax({
                        url: "{{ route('admin.sellers.bulk-import-ii') }}",
                        type: 'post',
                        data: formData[key],
                        dataType: 'json',
                        contentType: false,
                        ...
                        success: function(data){
                            if(data.errors){
                                ...
                                if(row == source_length){
                                    location.replace("{{route('admin.sellers.seller-list')}}")
                                }
                            }
                        },
                        error: function(){
