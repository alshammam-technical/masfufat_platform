                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            <li class="breadcrumb-item"><a class="breadcrumb-link"
                                                           href="{{route('admin.orders.list',['status'=>'all'])}}">{{\App\CPU\Helpers::translate('Orders')}}</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">{{\App\CPU\Helpers::translate('Order details')}}</li>
                        </ol>
                    </nav>

                    <div class="d-sm-flex align-items-sm-center">
                        <h1 class="page-header-title">{{\App\CPU\Helpers::translate('Order')}} #{{$order['id']}}</h1>
                        {{-- {{ $order}} --}}

                        @if($order['payment_status']=='paid')
                            <span class="badge badge-soft-success {{Session::get('direction') === "rtl" ? 'mr-sm-3' : 'ml-sm-3'}}">
                            <span class="legend-indicator bg-success" style="{{Session::get('direction') === "rtl" ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;'}}"></span>{{\App\CPU\Helpers::translate('Paid')}}
                        </span>
                        @else
                            <span class="badge badge-soft-danger {{Session::get('direction') === "rtl" ? 'mr-sm-3' : 'ml-sm-3'}}">
                            <span class="legend-indicator bg-danger" style="{{Session::get('direction') === "rtl" ? 'margin-right: 0;margin-left: .4375rem;' : 'margin-left: 0;margin-right: .4375rem;'}}"></span>{{\App\CPU\Helpers::translate('Unpaid')}}
                        </span>
                        @endif
                    ...
                    <div class="col-md-6 mt-2">
                        <a class="text-body" target="_blank"
                           href={{route('admin.orders.generate-invoice',[$order['id']])}}>
                            <i class="tio-print"></i> {{\App\CPU\Helpers::translate('Print invoice')}}
                        </a>
                    </div>
                    ...
                    <div class="card-header" style="display: block!important;">
                        <div class="row">
                            <div class="col-12 pb-2 border-bottom">
                                <h4 class="card-header-title">{{\App\CPU\Helpers::translate('Order details')}}
                            ...
                            <div class="col-12 text-right">
                                <div>
                                    <h6 class="text-capitalize" style="display: inline; color: #8a8a8a; ">{{\App\CPU\Helpers::translate('payment method')}} :</h6>
                                    <h6 class="mx-1" style="display: inline; color: #8a8a8a;">{{str_replace('_',' ',$order['payment_method'])}}</h6>
                                </div>
                                <div>
                                    <h6 style="display: inline; color: #8a8a8a;">{{\App\CPU\Helpers::translate('Payment reference')}} :</h6>
                    ...
                    <div class="card-body">
                        <div class="media">
                            <div class="avatar avatar-xl {{Session::get('direction') === "rtl" ? 'ml-3' : 'mr-3'}}">
                                <p>{{\App\CPU\Helpers::translate('image')}}</p>
                            </div>

                            <div class="media-body">
                                <div class="row">
                                    <div class="col-md-5 product-name">
                                        <p> {{\App\CPU\Helpers::translate('Name')}}</p>
                                    </div>

                                    <div class="col col-md-1 align-self-center p-0 ">
                                        <p> {{\App\CPU\Helpers::translate('price')}}</p>
                                    </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="row">
                                            ...
                                            <div class="col col-md-1 align-self-center p-0 ">
                                                <h6>{{\App\CPU\BackEndHelper::set_symbol(($detail['price']))}}</h6>
                                            </div>
                                            ...
                                            <div class="col col-md-1 align-self-center  p-0 product-name">
                                                <h6>{{\App\CPU\BackEndHelper::set_symbol(($detail['tax']))}}</h6>
                                            </div>
                                            <div class="col col-md-2 align-self-center  p-0 product-name">

                                                <h5>  {{\App\CPU\BackEndHelper::set_symbol(($detail['discount']))}}</h5>
                                            </div>
                                            ...
                                            <div class="col col-md-2 align-self-center text-{{Session::get('direction') === "rtl" ? 'left' : 'right'}}">
                                                ...
                                                <h5>{{\App\CPU\BackEndHelper::set_symbol(($subtotal))}}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row justify-content-md-end mb-3">
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-sm-right">
                                    <dt class="col-sm-6">{{\App\CPU\Helpers::translate('Shipping')}}</dt>
                                    <dd class="col-sm-6 border-bottom">
                                        <strong>{{\App\CPU\BackEndHelper::set_symbol(($shipping))}}</strong>
                                    </dd>
                                    ...
                                    <dd class="col-sm-6">
                                        <strong>{{\App\CPU\BackEndHelper::set_symbol(($total+$shipping-$coupon_discount))}}</strong>
                                    </dd>
                                </dl>
                                <!-- End Row -->
                            </div>
            ...
            <div class="col-lg-4">
                <div class="card mb-2">
                    <div class="card-header">
                        <h4>{{\App\CPU\Helpers::translate('shipping_info')}}</h4>
                    </div>
                ...
                <div class="card">
                    <!-- Header -->
                    <div class="card-header">
                        <h4 class="card-header-title">{{\App\CPU\Helpers::translate('Customer')}}</h4>
                    </div>
                    <!-- End Header -->
                    ...
                    @if($order->customer)
                        ...
                        <div class="card-body" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <h5>{{\App\CPU\Helpers::translate('Contact info')}}</h5>
                            </div>
