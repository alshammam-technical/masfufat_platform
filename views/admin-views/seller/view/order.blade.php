        ...
        <div class="flex-between d-sm-flex row align-items-center justify-content-between mb-2 mx-1">
            <div>
                <a href="{{route('admin.sellers.seller-list')}}"
                   class="btn btn--primary btn-primary mt-3 mb-3">{{\App\CPU\Helpers::translate('Back_to_seller_list')}}</a>
            </div>
            <div>
                    ...
                    <div class="col-md-12">
                        <div class="card w-100">
                            <div class="card-header">
                                <h5 class="mb-0">{{\App\CPU\Helpers::translate('Order info')}}</h5>
                            </div>
                            <!-- Card -->
                                    ...
                                    <div class="col-md-4">
                                        <div class="order-stats order-stats_all">
                                            <div class="order-stats__content"
                                                ...
                                                <i class="tio-table"></i>
                                                <h6 class="order-stats__subtitle">{{\App\CPU\Helpers::translate('All')}}</h6>
                                            </div>
                            ...
                            <div class="table-responsive datatable-custom">
                                <table id="datatable"
                                    ...
                                    <tr>
                                        ...
                                        <th>{{\App\CPU\Helpers::translate('Order')}}</th>
                                        <th>{{\App\CPU\Helpers::translate('order date & time')}}</th>
                                        <th>{{\App\CPU\Helpers::translate('Customer')}}</th>
                                        <th>{{\App\CPU\Helpers::translate('Payment status')}}</th>
                                        <th>{{\App\CPU\Helpers::translate('order value')}}</th>
                                    ...
                                    @foreach($orders as $key=>$order)
                                        ...
                                        <tr class="status class-all">
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <label
                                                        class="badge badge-soft-danger fz-12">{{\App\CPU\Helpers::translate('Removed')}}</label>
                                                @endif
                                            </td>
                                            <td>
                                                @if($order->payment_status=='paid')
                                                    <span
                                                        class="badge badge-soft-info fz-12">{{\App\CPU\Helpers::translate('paid')}}</span>
                                                @else
                                                    <span class="badge badge-soft-danger fz-12">{{\App\CPU\Helpers::translate('unpaid')}}
                                                </span>
                                                @endif
                                            </td>
                                            ...
                                            <td class="text-capitalize">
                                                @if($order['order_status']=='pending')
                                                    <span
                                                        class="badge badge-soft-info fz-12">{{\App\CPU\Helpers::translate('pending')}}</span>
                                                @elseif($order['order_status']=='confirmed')
                                                    <span
                                                        class="badge badge-soft-info fz-12">{{\App\CPU\Helpers::translate('confirmed')}}</span>
                                                @elseif($order['order_status']=='processing')
                                                    <span
                                                        class="badge badge-soft-warning fz-12">{{\App\CPU\Helpers::translate('processing')}}</span>
                                                @elseif($order['order_status']=='out_for_delivery')
                                                    <span
                                                        class="badge badge-soft-warning fz-12">{{\App\CPU\Helpers::translate('out_for_delivery')}}</span>
                                                @elseif($order['order_status']=='delivered')
                                                    <span
                                                        class="badge badge-soft-success fz-12">{{\App\CPU\Helpers::translate('delivered')}}</span>
                                                @else
                                                    <span
                                                        class="badge badge-soft-danger fz-12">{{\App\CPU\Helpers::translate(str_replace('_',' ',$order['order_status']))}}</span>
                                                @endif
                                            </td>
                                            <td>
