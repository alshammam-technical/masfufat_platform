...
@section('title', \App\CPU\Helpers::translate('Dashboard'))
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header pb-0 mb-0 border-0">
                <div class="flex-between align-items-center">
                    <div>
                        <h1 class="page-header-title" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">{{\App\CPU\Helpers::translate('Dashboard')}}</h1>
                        <p>{{ \App\CPU\Helpers::translate('Welcome_message')}}.</p>
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
                    ...
                    <div class="row flex-between align-items-center g-2 mb-3">
                        <div class="col-sm-6">
                            <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                                <img src="{{asset('/public/assets/back-end/img/business_analytics.png')}}" alt="">{{\App\CPU\Helpers::translate('business_analytics')}}</h4>
                        </div>
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-3">
                        ...
                        {{\App\CPU\Helpers::translate('admin_wallet')}}
                    </h4>
                            ...
                            <div class="row g-2 align-items-center">
                                <div class="col-md-6">
                                    <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                                        ...
                                        {{\App\CPU\Helpers::translate('earning_statistics')}}
                                    </h4>
                                </div>
                                        ...
                                        <li>
                                            <label>
                                                ...
                                                <span data-earn-type="yearEarn"
                                                      onclick="earningStatisticsUpdate(this)">{{\App\CPU\Helpers::translate('This_Year')}}</span>
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <span data-earn-type="MonthEarn"
                                                      onclick="earningStatisticsUpdate(this)">{{\App\CPU\Helpers::translate('This_Month')}}</span>
                                            </label>
                                        </li>
                                        <li>
                                            <label>
                                                ...
                                                <span data-earn-type="WeekEarn"
                                                      onclick="earningStatisticsUpdate(this)">{{\App\CPU\Helpers::translate('This Week')}}</span>
                                            </label>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="chartjs-custom mt-2" id="set-new-graph">
                                <canvas id="updatingData"
                                        data-hs-chartjs-options='{
                                            "type": "bar",
                                            "data": {
                                              "labels": ["{{Helpers::translate("Jan")}}","{{Helpers::translate("Feb")}}","{{Helpers::translate("Mar")}}","{{Helpers::translate("April")}}","{{Helpers::translate("May")}}","{{Helpers::translate("Jun")}}","{{Helpers::translate("Jul")}}","{{Helpers::translate("Aug")}}","{{Helpers::translate("Sep")}}","{{Helpers::translate("Oct")}}","{{Helpers::translate("Nov")}}","{{Helpers::translate("Dec")}}"],
                                              "datasets": [{
                                                "label": "{{Helpers::translate('In-house')}} ",
                                              ...
                                              {
                                                "label": "{{Helpers::translate('Sellers Products')}}",
                                              ...
                                              {
                                                "label": "{{Helpers::translate('Commission')}}",
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-12 mb-2 mb-sm-0">
                        <h3 class="text-center">{{\App\CPU\Helpers::translate('hi')}} {{auth('admin')->user()->name}}, {{\App\CPU\Helpers::translate('welcome_to_dashboard')}}.</h3>
                    </div>
                </div>
            </div>
            <!-- End Page Header -->
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    labels: [
                        ...
                        '{{\App\CPU\Helpers::translate('store')}} ',
                        '{{\App\CPU\Helpers::translate('product')}} ',
                        '{{\App\CPU\Helpers::translate('order')}} ',
                        '{{\App\CPU\Helpers::translate('brand')}} ',
                    ],
                    datasets: [{
                        label: '{{\App\CPU\Helpers::translate('business')}}',
