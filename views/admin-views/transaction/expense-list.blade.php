...
@section('title', \Helpers::translate('expense_transaction'))
         ...
         <div class="store-report-content mb-2">
            <div class="left-content expense--content">
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">
                            <span>{{\Helpers::translate('Total_Expense')}}</span>
                            <span class="ml-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('free_delivery_coupon')}}, {{\Helpers::translate('coupon_discount_will_be_shown_here')}}">
                ...
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">{{\Helpers::translate('Free_Delivery_Coupon')}}</h6>
                    </div>
                </div>
                <div class="left-content-card">
                    ...
                    <div class="info">
                        ...
                        <h6 class="subtext">
                            <span>{{\Helpers::translate('Coupon_Discount')}}</span>
                            <span class="ml-2" data-toggle="tooltip" data-placement="top" title="{{\Helpers::translate('discount_on_purchase_and_first_delivery_coupon_amount_will_be_shown_here')}}">
                                <img class="info-img" src="{{asset('/public/assets/back-end/img/info-circle.svg')}}" alt="img">
                            </span>
                        </h6>
                    </div>
            ...
            <div class="center-chart-area">
                <div class="center-chart-header">
                    <h3 class="title">{{\Helpers::translate('expense_Statistics')}}</h3>
                </div>
                ...
                "data": {
                  ...
                  "datasets": [{
                    "label": "{{\Helpers::translate('total_expense_amount')}}",
                ...
                <div class="d-flex flex-wrap gap-3 align-items-center">
                    ...
                    <form action="" method="GET" class="mb-0">
                        ...
                        <div class="input-group input-group-merge input-group-custom">
                            ...
                            <input id="datatableSearch_" type="search" name="search" class="form-control"
                                    placeholder="{{ \Helpers::translate('Search_by_Order_ID_or_Transaction_ID')}}"
                                    aria-label="Search orders"
                                    value="{{ $search }}"
                                    required>
                            <button type="submit"
                                    class="btn btn--primary">{{ \Helpers::translate('search')}}</button>
                        </div>
                        <!-- End Search -->
                    </form>
                    <div>
                    ...
                    <div>
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            <li>
                                <a class="dropdown-item" href="{{ route('admin.transaction.expense-transaction-export-excel', ['search'=>request('search'), 'date_type'=>request('date_type'), 'from'=>request('from'), 'to'=>request('to')]) }}"  >{{\Helpers::translate('Excel')}}</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="table-responsive">
                <table id="datatable"
                    ...
                    <tr>
                        ...
                        <th>{{\Helpers::translate('XID')}}</th>
                        <th>{{\Helpers::translate('Transaction Date')}}</th>
                        <th>{{\Helpers::translate('Order ID')}}</th>
                        <th>{{\Helpers::translate('Expense Amount')}}</th>
                        <th>{{\Helpers::translate('Expense Type')}}</th>
