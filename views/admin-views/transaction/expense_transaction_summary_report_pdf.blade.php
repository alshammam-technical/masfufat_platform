    ...
    <tr>
        <td class="pt-0">
            <table class="bs-0">
                <tr>
                    <td class="p-0 text-left">
                        <span class="bold black p-0 text-left">{{\Helpers::translate('duration')}}</span> :
    ...
    <tr>
        <td class="pt-0">
            <table class="bs-0 __product-table inter">
                <tbody>
                    <tr>
                        <td style="background-color: #0177CD important; color: white; font-weight: bold;text-align:center">{{\Helpers::translate('SL')}}</td>
                    ...
                    <tr>
                        ...
                        <td>{{\Helpers::translate('Total_Expense_Amount')}}</td>
                        <td class="text-right">
                    ...
                    <tr>
                        ...
                        <td>{{\Helpers::translate('Free_Delivery_Amount')}}</td>
                        <td class="text-right">
                    ...
                    <tr>
                        ...
                        <td>{{\Helpers::translate('Coupon_Discount_Amount')}}</td>
                        <td class="text-right">
...
<table class="">
    <tr>
        <th class="content-position-y bg-light py-4 footer">
            ...
            <div>
                {{\Helpers::translate('All_copy_right_reserved_©_'.date('Y').'_').$data['company_name']}}
            </div>
        </th>
    </tr>
</table>
