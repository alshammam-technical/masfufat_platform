            ...
            <table class="bs-0">
                <tr>
                    <th class="h3 p-0 text-left">
                        {{\Helpers::translate('Oder_Transaction_Statement')}}
                    </th>
            ...
            <table class="bs-0">
                <tr>
                    <td class="p-0 text-left">
                        <b class="bold black">{{\Helpers::translate('date')}}</b> : {{ date('F d, Y') }} <span class="block h-5"></span>
                    </td>
                </tr>
            </table>
        </td>
            ...
            <table class="bs-0">
                <tr>
                    <td class="p-0 text-left">
                        <table>
                            <tr>
                                <th class="bold black p-0 text-left" style="padding: 3px 0">{{\Helpers::translate('duration')}}</th>
                                <td class="p-0" style="padding: 3px 0;text-transform:capitalize">: {{ $duration }}</td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left" style="padding: 3px 0">{{\Helpers::translate('Seller_Info')}}</th>
                                <td class="p-0" style="padding: 3px 0">:
                                    {{ $seller_info }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left" style="padding: 3px 0">{{\Helpers::translate('Customer_Info')}}</th>
                                <td class="p-0" style="padding: 3px 0">:
                                    {{ $customer_info }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left" style="padding: 3px 0">{{\Helpers::translate('status')}}</th>
                                <td class="p-0" style="padding: 3px 0">:
                                    {{ $status }}
                                </td>
                            </tr>
                    ...
                    <td class="p-0 text-left">
                        <table>
                            <tr>
                                <th class="bold black p-0 text-left">{{\Helpers::translate('Total_Order')}} </th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['total_orders'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left">{{\Helpers::translate('In-House_Order')}}</th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['in_house_orders'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left">{{\Helpers::translate('Seller_Order')}}</th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['seller_orders'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left">{{\Helpers::translate('Total_In-House_Products')}}</th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['total_in_house_products'] }}
                                </td>
                            </tr>
                            <tr>
                                <th class="bold black p-0 text-left">{{\Helpers::translate('Total_Stores')}}</th>
                                <td class="p-0" style="padding: 3px 0;">:
                                    {{ $data['total_stores'] }}
                                </td>
                            </tr>
    ...
    <tr>
        <td class="pt-0">
            <table class="bs-0 __product-table inter">
                <tbody>
                <tr>
                    <td class="pl-0 pr-0 text-center" style="background-color: #0177CD important; color: white; font-weight: bold">{{\Helpers::translate('SL')}}</td>
                    <td style="background-color: #0177CD important; color: white; font-weight: bold">{{\Helpers::translate('details')}}</td>
                    <td class="text-right" style="background-color: #0177CD important; color: white; font-weight: bold">{{\Helpers::translate('amount')}}</td>
                </tr>
                <tr>
                    <td class="text-center">1</td>
                    <td>{{\Helpers::translate('Total_Ordered_Product_Price')}}</td>
                    <td class="text-right">
                ...
                <tr>
                    ...
                    <td>{{\Helpers::translate('Total_Product_Discount')}}</td>
                    <td class="text-right">
                ...
                <tr>
                    ...
                    <td>{{\Helpers::translate('Total_Coupon_Discount')}}</td>
                    <td class="text-right">
                ...
                <tr>
                    ...
                    <td>{{\Helpers::translate('Total_Discounted_Amount')}}</td>
                    <td class="text-right">
                ...
                <tr>
                    ...
                    <td>{{\Helpers::translate('total')}} {{\Helpers::translate('VAT/TAX')}}</td>
                    <td class="text-right">
                ...
                <tr>
                    ...
                    <td>{{\Helpers::translate('Total_Delivery_Charge')}}</td>
                    <td class="text-right">
                ...
                <tr>
                    ...
                    <td>{{\Helpers::translate('Total_Order_Amount')}}</td>
                    <td class="text-right">
...
<table class="content-position">
    <tr>
        <th class="text-left black bold"><b>{{\Helpers::translate('additional')}} {{\Helpers::translate('information')}}</b></th>
        <th class="text-right black bold"><b>{{\Helpers::translate('totals')}}</b></th>
    </tr>
    <tbody class="bs-0 __product-table inter add-info-border-top-bottom">
    <tr>
        <td>
            {{\Helpers::translate('Admin_Discount')}}
        </td>
        <td class="text-right">
    ...
    <tr>
        <td>
            {{ \Helpers::translate('Seller_Discount') }}
        </td>
        <td class="text-right">
    ...
    <tr>
        <td>
            {{ \Helpers::translate('Admin_Commission') }}
        </td>
        <td class="text-right">
    ...
    <tr>
        <td>
            {{\Helpers::translate('Admin_Net_Income')}}
        </td>
        <td class="text-right">
    ...
    <tr>
        <td>
            {{\Helpers::translate('Seller_Net_Income')}}
        </td>
        <td class="text-right">
...
<table class="">
    <tr>
        <th class="content-position-y bg-light py-4 footer">
            ...
            <div>
                {{\Helpers::translate('All_copy_right_reserved_©_'.date('Y').'_').$company_name}}
            </div>
        </th>
    </tr>
</table>
