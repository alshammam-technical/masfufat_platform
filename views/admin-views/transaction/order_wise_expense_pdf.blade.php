                ...
                <table class="bs-0">
                    <tr>
                        <th class="h3 p-0 text-left">
                            {{\Helpers::translate('Expense_Transaction_Statement')}}
                        </th>
                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">{{\Helpers::translate('Transaction_Date')}}</th>
                                    <td class="p-0" style="padding: 3px 0">: {{ date_format($transaction->order_transaction->updated_at, 'd F Y') }}</td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">{{\Helpers::translate('Order_ID')}}</th>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{\Helpers::translate('XID')}}</th>
                                    <td class="p-0" style="padding: 3px 0;">: {{ ucfirst($transaction->order_transaction->transaction_id) }}</td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{\Helpers::translate('Expense_Type')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
        ...
        <tr>
            <td class="pt-0">
                <table class="bs-0 __product-table inter">
                    <tbody>
                        <tr>
                            <td style="background-color: #0177CD important; color: white; font-weight: bold;">{{\Helpers::translate('SL')}}</td>
                        ...
                        <tr>
                            <td class="">1</td>
                            <td>{{\Helpers::translate('Expense_Amount')}}</td>
                            <td class="text-right">
