                ...
                <table class="bs-0">
                    <tr>
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left" style="padding: 3px 0">{{\Helpers::translate('date')}}</th>
                        ...
                        <td class="p-0 text-left">
                            <table>
                                <tr>
                                    <th class="bold black p-0 text-left">{{\Helpers::translate('Delivered_By')}} </th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        @if($transaction->order->delivery_type =='self_delivery' && !empty($transaction->order->delivery_man_id))
                                            {{\Helpers::translate('delivery_man')}} {{ $transaction->order->delivery_man->seller_id == 0 ? 'admin':'seller' }}
                                        @else
                                ...
                                <tr>
                                    <th class="bold black p-0 text-left">{{\Helpers::translate('Payment_Method')}}</th>
                                    <td class="p-0" style="padding: 3px 0;">:
                                        ...
                                        @else
                                            {{\Helpers::translate('digital_payment')}}
                                        @endif
                                        </td>
                                </tr>
                                <tr>
                                    <th class="bold black p-0 text-left">{{\Helpers::translate('Payment_Status')}}</th>
                ...
                <table class="bs-0 __product-table inter">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{\Helpers::translate('Total_Product_Amount')}}</td>
                            <td class="text-right">
                        ...
                        <tr>
                            ...
                            <td>{{\Helpers::translate('Product_Discount')}}</td>
                            <td class="text-right">
                        ...
                        <tr>
                            ...
                            <td>{{\Helpers::translate('Coupon_Discount')}}</td>
                            <td class="text-right">
                        ...
                        <tr>
                            ...
                            <td>{{\Helpers::translate('Discounted_Amount')}}</td>
                            <td class="text-right">
                        ...
                        <tr>
                            ...
                            <td>{{\Helpers::translate('VAT/TAX')}}</td>
                            <td class="text-right">
                        ...
                        <tr>
                            ...
                            <td>{{\Helpers::translate('Delivery_Charge')}}</td>
                            <td class="text-right">
                        ...
                        <tr>
                            ...
                            <td>{{\Helpers::translate('Order_Amount')}}</td>
                            <td class="text-right">
