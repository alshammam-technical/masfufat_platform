        ...
        <div class="row justify-content-center">
            <div class="col-md-7">
                <div class="card border-1 box-shadow-0">
                    <div class="card-body">
                        <div class="row mt-0 mb-3 ps-1 pe-4">
                            ...
                            @foreach (\App\CPU\Helpers::get_business_settings('social_login') as $socialLoginService)
                                @if (isset($socialLoginService) && $socialLoginService['status']==true)
                                    <div class="col-sm-6 text-center mb-1">
                                        <a class="btn @if(Route::is('customer.auth.service-login', $socialLoginService['login_medium'])) btn-primary @elseif($socialLoginService['login_medium'] == 'regular_login') btn-primary @else btn-white @endif border-0"
