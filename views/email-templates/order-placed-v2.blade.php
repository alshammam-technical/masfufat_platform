...
<head>
  ...
  <title>{{\App\CPU\Helpers::translate('Order Placed')}}</title>
...
<div style="width:650px;margin:auto; background-color:white;margin-top:100px;
    ...
    <table style="background-color: rgb(255, 255, 255);width: 90%;margin:auto;height:72px; border-bottom:1px ridge;">
        <tbody>
            <tr>
                <td>
                    <h2 >{{\App\CPU\Helpers::translate('thanks_for_the_order')}}</h2>
                    <h3 style="color:green;">{{\App\CPU\Helpers::translate('Your_order_ID')}} : {{$id}}</h3>
                </td>
                <td>
            ...
            <tr style="width: 100%;">
                <td style="width:50%;vertical-align: top; margin-top:5px;">
                    ...
                    <div style="text-align:left;margin-top:10px;">
                      <span style="color: #130505 !important;text-transform: capitalize;font-weight: bold;">{{\App\CPU\Helpers::translate('seller_details')}}  </span><br>
                    ...
                    <div style="display:flex; align-items:center;margin-top:10px;">
                        <span>
                            {{\App\CPU\Helpers::translate('inhouse_products')}}
                        </span>
                    </div>
                    @endif
                  </div>
                ...
                <td style="width:50%;vertical-align: top;">
                    <div style="text-align:right;margin-top:10px;">
                        <span style="color: #130505 !important;text-transform: capitalize;font-weight: bold;">{{\App\CPU\Helpers::translate('payment_details')}}  </span><br>
                ...
                <tbody style="">
                    {{-- <div style="margin-top:100px;"> --}}
                        <tr style="border-bottom: 1px ridge;text-transform: capitalize;">
                            <th style="padding-bottom: 8px;width:10%;">{{\App\CPU\Helpers::translate('SL')}}</th>
                            <th style="padding-bottom: 8px;width:40%;">{{\App\CPU\Helpers::translate('Ordered_Items')}}</th>
                            <th style="padding-bottom: 8px;width:15%">{{\App\CPU\Helpers::translate('Unit_price')}}</th>
                            <th style="padding-bottom: 8px;width:15%;">{{\App\CPU\Helpers::translate('QTY')}}</th>
                            <th style="padding-bottom: 8px;width:20%;">{{\App\CPU\Helpers::translate('Total')}}</th>
                        </tr>
    ...
    <table style="background-color: rgb(255, 255, 255);width: 90%;margin:auto;margin-top:30px;">
        <tbody style="">
                ...
                <tr style="">
                    <td>{{\App\CPU\Helpers::translate('You_can_track_your_order_by_clicking_the_below_button')}}</td>
                </tr>
                <tr>
                    <td>
                      <?php
                      ...
                      ?>
                          ...
                          <div style="margin-top: 50px; margin-bottom:30px">
                            <a href="{{route('track-order.result',['order_id'=>$order->id,'phone_number'=>$user_phone])}}" style="background-color: #1a82e2; padding:20px;border:none;
                              ...
                              {{\App\CPU\Helpers::translate('track_your_order')}}
                            </a>
                          </div>
                    </td>
                </tr>
...
<div style="padding:5px;width:650px;margin:auto;margin-top:5px; margin-bottom:50px;">
    ...
    <table style="margin:auto;width:90%; color:#777777;">
        <tbody>
            ...
            <tr>
                <th style="text-align: left;">
                    <div> {{\App\CPU\Helpers::translate('phone')}}
                        : {{\App\Model\BusinessSetting::where('type','company_phone')->first()->value}}</div>
                    <div> {{\App\CPU\Helpers::translate('website')}}
                        : {{url('/')}}</div>
                    <div > {{\App\CPU\Helpers::translate('email')}}
                        : {{$company_email}}</div>
                </th>
