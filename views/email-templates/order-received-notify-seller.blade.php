...
<head>
    ...
    <title>{{\App\CPU\Helpers::translate('New order received')}}</title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer"
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2"
                        ...
                        <span style="font-size: 18px; font-weight: normal;">{{\App\CPU\Helpers::translate('Notification mail for new order received')}}</span>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                        ...
                        <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                            ...
                            {{\App\CPU\Helpers::translate('We have sent you this email to notify that you have a new order. You will be able to see your orders after login to your panel')}}.

                            <br/><br/>

                            {{\App\CPU\Helpers::translate('New order ID for you')}} :

                            <a href="javascript:"> <h3 style="font-weight: 1000">{{$id}}</h3> </a>

                            <br/><br/>

                            {{\App\CPU\Helpers::translate('If you need help, or you have any other questions, feel free to email us')}}.

                            <br/><br/>

                            {{\App\CPU\Helpers::translate('From')}} {{$web_config['name']->value}}
