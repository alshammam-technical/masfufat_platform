                            ...
                            <div id="messageDropdown"
                                ...
                                <a class="dropdown-item position-relative"
                                   href="{{route('seller.messages.chat', ['type' => 'customer'])}}">
                                    <span class="text-truncate pr-2"
                                          title="Settings">{{\App\CPU\Helpers::translate('Customer')}}</span>
                                ...
                                <a class="dropdown-item position-relative"
                                   href="{{route('seller.messages.chat', ['type' => 'delivery-man'])}}">
                                    <span class="text-truncate pr-2"
                                          title="Settings">{{\App\CPU\Helpers::translate('Delivery_man')}}</span>
                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item"
                                   href="{{route('seller.profile.update',auth('seller')->user()->id)}}">
                                    <span class="text-truncate pr-2"
                                          title="Settings">{{\App\CPU\Helpers::translate('Settings')}}</span>
                                </a>

                                <div class="dropdown-divider"></div>

                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    title: '{{\App\CPU\Helpers::translate('Do you want to logout')}}?',
                                    showDenyButton: true,
                                    ...
                                    <span class="text-truncate pr-2"
                                          title="Sign out">{{\App\CPU\Helpers::translate('Sign out')}}</span>
                                </a>
                            </div>
                        </div>
                        <!-- End Account -->
