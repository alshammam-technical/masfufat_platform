                            ...
                            <div id="accountNavbarDropdown"
                                ...
                                <a class="dropdown-item"
                                   href="{{route('admin.profile.update',auth('admin')->user()->id)}}">
                                    <span class="text-truncate pr-2" title="{{\App\CPU\Helpers::translate('Settings')}}">{{\App\CPU\Helpers::translate('Settings')}}</span>
                                </a>

                                <form action="{{route('admin.profile.lang-editor-mode')}}" method="POST">
                                    @csrf
                                    <button class="dropdown-item"href="#">
                                        <span class="text-truncate pr-2" title="{{\App\CPU\Helpers::translate('captions editing mode')}}">{{\App\CPU\Helpers::translate('captions editing mode')}}</span>
                                    </button>
                                </form>
                                ...
                                <a class="dropdown-item" href="javascript:" onclick="Swal.fire({
                                    ...
                                    <span class="text-truncate pr-2" title="{{\App\CPU\Helpers::translate('Sign out')}}">{{\App\CPU\Helpers::translate('Sign out')}}</span>
                                </a>
                            </div>
                        </div>
                        <!-- End Account -->
                ...
                <div class="bg-white p-1 rounded mt-2">
                    <a title="Website home" class="p-2 title-color"
                       href="{{route('home')}}" target="_blank">
                        ...
                        {{\App\CPU\Helpers::translate('view_website')}}
                    </a>
                </div>
                    ...
                    <div class="bg-white p-1 rounded mt-2">
                        <a class="p-2  title-color"
                           href="{{route('admin.contact.list')}}">
                            <i class="tio-email"></i>
                            {{\App\CPU\Helpers::translate('message')}}
