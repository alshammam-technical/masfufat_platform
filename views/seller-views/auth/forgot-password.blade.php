...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CPU\Helpers::translate('forgot_password')}}</title>
    ...
    <div class="container py-5 py-sm-7">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <h2 class="h3 mb-4">{{\App\CPU\Helpers::translate('forgot_password?')}}</h2>
                <p class="font-size-md">{{\App\CPU\Helpers::translate('follow_steps')}}</p>
                <ol class="list-unstyled font-size-md">
                    <li><span class="text-primary mr-2">1.</span>{{\App\CPU\Helpers::translate('Fill in your email address below')}}.</li>
                    <li><span class="text-primary mr-2">2.</span>{{\App\CPU\Helpers::translate('We will send email you a temporary code')}}.</li>
                    <li><span class="text-primary mr-2">3.</span>{{\App\CPU\Helpers::translate('Use the code to change your password on our secure
                        website')}}.
                    </li>
                </ol>
                    ...
                    <div class="card py-2 mt-4">
                        <form class="card-body needs-validation" action="{{route('seller.auth.forgot-password')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">{{\App\CPU\Helpers::translate('Please provide valid email address')}}.</div>
                            </div>
                            <button class="btn btn-primary" type="submit">{{\App\CPU\Helpers::translate('Get new password')}}</button>
                        </form>
                    </div>
                @else
                    <div class="card py-2 mt-4">
                        <form class="card-body needs-validation" action="{{route('seller.auth.forgot-password')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">{{\App\CPU\Helpers::translate('Please provide valid phone number')}}.</div>
                            </div>
                            <button class="btn btn--primary btn-primary" type="submit">{{\App\CPU\Helpers::translate('Get new password')}}</button>
                        </form>
                    </div>
                @endif
            </div>
