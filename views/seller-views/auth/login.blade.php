...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CPU\Helpers::translate('seller_login')}}</title>
                ...
                <div class="card card-lg mb-5">
                    <div class="card-body">
                        ...
                        <form id="form-id"  action="{{route('seller.auth.login')}}" method="post">
                            ...
                            <div class="text-center">
                                <div class="mb-5">
                                    <h1 class="display-4">{{\App\CPU\Helpers::translate('sign_in')}}</h1>
                                    <center><h1 class="h4 text-gray-900 mb-4">{{\App\CPU\Helpers::translate('welcome_back_to_seller_login')}}</h1>
                                    </center>
                                </div>
                                ...
                                <div class="row p-2">
                                    <div class="col-6 pr-0">
                                        <input type="text" class="form-control form-control-lg" name="default_captcha_value" value=""
                                            placeholder="{{\App\CPU\Helpers::translate('Enter captcha value')}}" class="border-0" autocomplete="off">
                                    </div>
                        ...
                        <a href="{{ route('shop.apply') }}" role="button" class="mt-2 btn btn-lg btn-block btn--primary">{{\App\CPU\Helpers::translate('sign up')}}</a>

                        <a href="{{ route('home') }}" class="mt-2">{{\App\CPU\Helpers::translate('back to main page')}}</a>
                        <!-- End Form -->
                    </div>
                    @if(env('APP_MODE')=='demo')
                        <div class="card-footer">
                            <div class="row">
                                <div class="col-10">
                                    <span>{{\App\CPU\Helpers::translate('Email')}} : test.seller@gmail.com</span><br>
                                    <span>{{\App\CPU\Helpers::translate('Password')}} : 12345678</span>
                                </div>
                                <div class="col-2">
...
@if(env('APP_MODE')=='demo')
    <script>
        function copy_cred() {
            ...
            toastr.success('{{\App\CPU\Helpers::translate("Copied successfully")}}!', 'Success!', {
                CloseButton: true,
                ProgressBar: true
            });
        }
