...
<head>
    ...
    <!-- Title -->
    <title>{{\App\CPU\Helpers::translate('Seller | Reset Password')}}</title>
    ...
    <div class="container py-5 py-sm-7">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10">
                <h2 class="h3 mb-4">{{\App\CPU\Helpers::translate('forget_your_password')}}?</h2>
                <p class="font-size-md">{{\App\CPU\Helpers::translate('follow_steps')}}
                    secure.</p>
                <ol class="list-unstyled font-size-md">
                    <li><span class="text-primary mr-2">1.</span>{{\App\CPU\Helpers::translate('new_password')}}.</li>
                    <li><span class="text-primary mr-2">2.</span>{{\App\CPU\Helpers::translate('confirm_password')}}.</li>
                </ol>
                    ...
                    <form class="card-body needs-validation" novalidate method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="password-toggle">
                                ...
                                <div class="invalid-feedback">{{\App\CPU\Helpers::translate('provide_valid_password')}}.</div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <button class="btn btn--primary btn-primary" type="submit">{{\App\CPU\Helpers::translate('reset_password')}}</button>
                    </form>
                </div>
            </div>
        </div>
