...
@section('title',\App\CPU\Helpers::translate('Chatting Page'))
    ...
    <div class="content container-fluid">
        ...
        <div class="col-lg-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">{{\App\CPU\Helpers::translate('messages')}}</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('Chatting_List')}}
            </h2>
        </div>
        <!-- End Page Title -->
        ...
        <div class="row">
                    ...
                    <div class="card card-body px-0 h-100">
                        <div class="media align-items-center px-3 gap-3 mb-4">
                            ...
                            <div class="media-body">
                                ...
                                <span class="fz-12">{{\App\CPU\Helpers::translate('Seller')}}</span>
                            </div>
                        </div>
                                ...
                                <div class="search-input-group">
                                    ...
                                    <input
                                        ...
                                        @if(Request::is('seller/messages/chat/customer'))
                                            placeholder="{{\App\CPU\Helpers::translate('Search_customers...')}}"
                                        @elseif(Request::is('seller/messages/chat/delivery-man'))
                                            placeholder="{{\App\CPU\Helpers::translate('Search_delivery_men...')}}"
                                        @endif
                                        ...
                                        <div class="input_msg_write">
                                            <form class="mt-4" id="myForm">
                                                ...
                                                <textarea
                                                    ...
                                                    id="msgInputValue"
                                                    type="text" placeholder="{{\App\CPU\Helpers::translate('Send a message')}}"
                                                    aria-label="Search"></textarea>
                                                <div class="mt-3 d-flex justify-content-end">
                                                    <button class="aSend btn btn--primary btn-primary" type="submit" id="msgSendBtn">{{\App\CPU\Helpers::translate('Send_Reply')}}</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
            ...
            @else
                <div class="offset-md-1 col-md-10" style="display:flex; justify-content: center; align-items: center;">
                    <p>{{\App\CPU\Helpers::translate('No conversation found')}}</p>
                </div>
            @endif
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.length != 0) {
                        ...
                        $(".msg_history").html(`<p> {{\App\CPU\Helpers::translate('No Message available')}} </p>`);
                        data = [];
                    }
