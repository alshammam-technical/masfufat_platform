            ...
            <div class="card mb-3">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\Helpers::translate('first name')}}</label>
                                <input type="text" value="{{$delivery_man['f_name']}}" name="f_name"
                                        class="form-control" placeholder="{{\App\CPU\Helpers::translate('New delivery-man')}}"
                                        required>
                            </div>

                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\Helpers::translate('last name')}}</label>
                                <input type="text" value="{{$delivery_man['l_name']}}" name="l_name"
                                        class="form-control" placeholder="{{\App\CPU\Helpers::translate('Last Name')}}"
                                        required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="phone" value="{{$delivery_man['phone']}}" class="form-control phoneInput" placeholder="{{\App\CPU\Helpers::translate('Ex : 017********')}}"
                                           required>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\Helpers::translate('identity type')}}</label>
                                <select name="identity_type" class="form-control">
                                    ...
                                    <option value="nid" {{$delivery_man['identity_type']=='nid'?'selected':''}}>{{\App\CPU\Helpers::translate('nid')}}
                                    </option>
                                    <option
                            ...
                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\Helpers::translate('identity number')}}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\Helpers::translate('identity image')}}</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="password" class="form-control" placeholder="{{\App\CPU\Helpers::translate('Ex : password')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label class="title-color">{{\App\CPU\Helpers::translate('confirm_password')}}</label>
                                <input type="text" name="confirm_password" class="form-control" placeholder="{{\App\CPU\Helpers::translate('Ex : password')}}">
                            </div>
                        </div>
                    </div>
