    ...
    <div class="content container-fluid" style="padding-{{(Session::get('direction') == 'rtl') ? 'right' : 'left'}}: 17%">
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                ...
                {{\App\CPU\Helpers::translate('deliveryman list')}}
        ...
        <div class="card">
            ...
            <div class="card-header flex-wrap gap-2">
                ...
                <a href="{{route('seller.delivery-man.add')}}" class="btn btn--primary btn-primary">
                    <i class="tio-add-circle"></i> {{\App\CPU\Helpers::translate('add deliveryman')}}
                </a>
            </div>
            <!-- End Header -->
