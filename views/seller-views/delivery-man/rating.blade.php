                        ...
                        <div>
                            <select class="form-control" name="rating">
                                <option value="" selected>
                                    --{{ \App\CPU\Helpers::translate('Select_Rating') }}--</option>
                                <option value="1" {{ $rating==1 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('1') }}</option>
                                <option value="2" {{ $rating==2 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('2') }}</option>
                                <option value="3" {{ $rating==3 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('3') }}</option>
                                <option value="4" {{ $rating==4 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('4') }}</option>
                                <option value="5" {{ $rating==5 ? 'selected': '' }}>{{ \App\CPU\Helpers::translate('5') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2">
