        ...
        <table class="table table-align-middle">
            <thead class="text-capitalize bg-light">
                <tr>
                    ...
                    <th class="border-0 text-center">{{\App\CPU\Helpers::translate('Action')}}</th>
                </tr>
            </thead>
            <tbody>
            <?php
...
{{--                    </script>--}}
    ...
    <div class="pt-4">
        <dl>
            ...
            <div class="d-flex gap-2 justify-content-between">
                <dt  class="title-color text-capitalize font-weight-normal">{{\App\CPU\Helpers::translate('coupon discount')}} :</dt>
                <dd>
                    <button id="coupon_discount" class="btn btn-sm" type="button" data-toggle="modal" data-target="#add-coupon-discount">
                        <i class="tio-edit"></i>
                    </button>
                    {{\App\CPU\BackEndHelper::set_symbol(($coupon_discount))}}</dd>
            </div>
            ...
            <div class="d-flex gap-2 justify-content-between">
                <dt  class="title-color text-capitalize font-weight-normal">{{\App\CPU\Helpers::translate('total')}} : </dt>
        ...
        @csrf
            ...
            <div class="pt-4 mb-4">
                ...
                <ul class="list-unstyled option-buttons">
                    <li>
                        ...
                        <label for="cash" class="btn btn--bordered btn--bordered-black px-4 mb-0">{{\App\CPU\Helpers::translate('cash')}}</label>
                    </li>
                    <li>
                        <input type="radio" value="card" id="card" name="type" hidden>
                        <label for="card" class="btn btn--bordered btn--bordered-black px-4 mb-0">{{\App\CPU\Helpers::translate('Card')}}</label>
                    </li>
                </ul>
            </div>
            <div class="d-flex gap-2 justify-content-between align-items-center pt-3">
                ...
                <button type="button" onclick="form_submit()" class="btn btn--primary btn-primary btn-block m-0"><i class="fa fa-shopping-bag"></i>
                    {{\App\CPU\Helpers::translate('place_Order')}} </button>
            </div>
        </form>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="d-flex justify-content-end">
                        <button class="btn btn--primary btn-primary px-4" type="submit" onclick="coupon_discount();">{{\App\CPU\Helpers::translate('apply')}}</button>
                    </div>
                </div>
            </div>
        </div>
