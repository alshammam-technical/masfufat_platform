                ...
                <div class="col-md-4 col-sm-12">
                    <div class="bg-light px-2 py-1">
                      ...
                      <div class="my-4 input-group">
                        ...
                        <div class="form-control p-0 text-start " dir="auto">
                          <input dir="rtl" name="options_values[{{$index}}][min_quantity_alert]" aria-describedby="basic-addon1" placeholder="{{\App\CPU\Helpers::translate('Min Quantity alert')}}" min="0" type="number" class="form-control" value="{{$product->min_quantity_alert}}">
                        </div>
                      </div>
                      <div class="my-4 input-group">
                      ...
                      <div hidden="">
                        <div class="input-group">
                          ...
                          <div class="form-control p-0 text-start " dir="auto">
                            <div class="react-datepicker-wrapper">
                              <div class="react-datepicker__input-container">
                                <input type="number" name="options_values[{{$index}}][start_time]" class="form-control" value="">
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="input-group">
                          ...
                          <div class="form-control p-0 text-start " dir="auto">
                            <div class="react-datepicker-wrapper">
                              <div class="react-datepicker__input-container">
                                <input type="number" name="options_values[{{$index}}][end_time]" class="form-control" value="">
                              </div>
                            </div>
                          </div>
                        </div>
