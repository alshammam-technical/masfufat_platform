            ...
            <div class="d-flex mx-3 overflow-auto h-100">
                ...
                <div class="px-3 py-1" style="min-width: 350px;">
                    ...
                    <div class="my-4 input-group">
                      ...
                      <div class="form-control p-0 text-start " dir="auto">
                        <input dir="rtl" name="min_quantity" aria-describedby="basic-addon1"  placeholder="{{Helpers::translate('Min quantity per order')}}" min="0" type="number" class="form-control"
                    ...
                    <div class="my-4 input-group">
                      ...
                      <div class="form-control p-0 text-start " dir="auto">
                        <input dir="rtl" name="max_quantity" aria-describedby="basic-addon1" placeholder="{{Helpers::translate('Max quantity per order')}}" min="0" type="number" class="form-control"
                ...
                <div class="px-3 py-1" style="min-width: 350px;">
                    ...
                    <div class="my-4 input-group">
                      <span class="custom-input-group-text input-group-text bg-primary text-light" style="width: auto; min-width: 155px; max-width: fit-content;">{{Helpers::translate('Min quantity per order')}}</span>
                      <div class="form-control p-0 text-start " dir="auto">
                        <input dir="rtl" name="pricing[{{$pl->id}}][min_qty]" aria-describedby="basic-addon1"  placeholder="{{Helpers::translate('Min quantity per order')}}" min="0" type="number" class="form-control"
                    ...
                    <div class="my-4 input-group">
                      <span class="custom-input-group-text input-group-text bg-primary text-light" style="width: auto; min-width: 155px; max-width: fit-content;">{{Helpers::translate('Max quantity per order')}}</span>
                      <div class="form-control p-0 text-start " dir="auto">
                        <input dir="rtl" name="pricing[{{$pl->id}}][max_qty]" aria-describedby="basic-addon1" placeholder="{{Helpers::translate('Max quantity per order')}}" min="0" type="number" class="form-control"
