...
@section('title', \App\CPU\Helpers::translate('Bank Info View'))
@push('css_or_js')
                ...
                <div class="card" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                    ...
                    <div class="border-bottom d-flex gap-3 flex-wrap justify-content-between align-items-center px-4 py-3">
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <h3 class="mb-0">{{\App\CPU\Helpers::translate('Bank Information')}}</h3>
                        </div>

                        <div class="d-flex gap-2 align-items-center">
                            <a href="{{route('seller.profile.bankInfo',[$data->id])}}" class="btn btn--primary btn-primary">
                                Update
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="col-sm-6 col-md-8 col-lg-6 col-xl-5">
                                ...
                                <div class="card bank-info-card bg-bottom bg-contain bg-img" style="background-image: url({{asset('/public/assets/back-end/img/bank-info-card-bg.png')}});">
                                    <div class="border-bottom p-3">
                                        <h4 class="mb-0 fw-semibold">{{\App\CPU\Helpers::translate('Holder_Name')}} : <strong>{{$data->holder_name ?? 'No Data found'}}</strong></h4>
                                    </div>
                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <ul class="list-unstyled d-flex flex-column gap-4">
                                            <li>
                                                <h3 class="mb-2">{{\App\CPU\Helpers::translate('Bank_Name')}} :</h3>
                                                <div>{{$data->bank_name ?? 'No Data found'}}</div>
                                            </li>
                                            <li>
                                                <h3 class="mb-2">{{\App\CPU\Helpers::translate('Branch_Name')}} :</h3>
                                                <div>{{$data->branch ?? 'No Data found'}}</div>
                                            </li>
                                            <li>
                                                <h3 class="mb-2">{{\App\CPU\Helpers::translate('Account_Number')}} : </h3>
