    ...
    <div class="col-lg-5">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">{{\App\CPU\Helpers::translate('refund_request_list')}}</li>
            </ol>
        </nav>
    </div>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-3">
            ...
            <div class="">
                <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                    ...
                    {{\App\CPU\Helpers::translate('refund_request_list')}}
            ...
            <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                ...
                <thead class="thead-light thead-50 text-capitalize">
                    <tr>
                        ...
                        <th>{{\App\CPU\Helpers::translate('Total_Amount')}}</th>
                        <th>{{\App\CPU\Helpers::translate('Order_Status')}}</th>
                ...
                @foreach($refund_list as $key=>$refund)
                    <tr>
                        ...
                        <td>
                            {{\App\CPU\Helpers::translate($refund->status)}}
                        </td>
                        <td>
                            <div class="d-flex justify-content-center gap-2">
                                <a  class="btn btn--primary btn-primary btn-sm square-btn"
