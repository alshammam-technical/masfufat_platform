    ...
    <div class="content container-fluid">
        ...
        <div class="col-lg-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item" aria-current="page">{{\App\CPU\Helpers::translate('Product_reviews')}}</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="mb-3">
            <h2 class="h1 mb-0 text-capitalize">
                ...
                {{\App\CPU\Helpers::translate('Product_reviews')}}
            </h2>
        </div>
        <!-- End Page Title -->
            ...
            <div class="row border-bottom pb-3 align-items-center mb-20">
                <div class="col-sm-4 col-md-6 col-lg-8 mb-2 mb-sm-0">
                    <h5 class="text-capitalize mb-0 d-flex gap-1">
                        {{ \App\CPU\Helpers::translate('Review') }} {{ \App\CPU\Helpers::translate('Table') }}
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="product" class="title-color">{{ \App\CPU\Helpers::translate('choose') }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="customer" class="title-color">{{ \App\CPU\Helpers::translate('choose') }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <label for="status" class="title-color">{{ \App\CPU\Helpers::translate('choose') }}
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="from" class="title-color">{{ \App\CPU\Helpers::translate('from') }}</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="to" class="title-color">{{ \App\CPU\Helpers::translate('to') }}</label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <button id="filter" type="submit" class="btn btn--primary btn-primary btn-block mt-5 filter">
                                <i class="tio-filter-list nav-icon"></i>{{ \App\CPU\Helpers::translate('filter') }}
                            </button>
                        </div>
                    </div>
                    <div class="col-md-2">
                ...
                <table
                    ...
                    <tbody>
                        ...
                        @if ($review['created_at'] == $review['updated_at'])
                            @php(\Illuminate\Support\Facades\DB::table('reviews')->where('id',$review['id'])->update([
                            ...
                            @if ($review->product)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <label class="badge badge-soft-danger">{{ \App\CPU\Helpers::translate('customer_removed') }}</label>
                                        @endif
                                    </td>
                                    <td>
