...
@section('title', \App\CPU\Helpers::translate('Add Shipping'))
...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="col-md-12 ">
                <div class="card">
                    <div class="card-header text-capitalize">
                        <h5 class="mb-0">{{\App\CPU\Helpers::translate('choose_shipping_method')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-12 mt-2" id="product_wise_note" style="display: none">
                                <p class="m-2" class="text-danger">{{\App\CPU\Helpers::translate('note')}}: {{\App\CPU\Helpers::translate("Please_make_sure_all_the product's_delivery_charges_are_up_to_date.")}}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div id="order_wise_shipping">
            <div class="card mt-2">
                <div class="card-header">
                    <h5 class="mb-0 text-capitalize">{{\App\CPU\Helpers::translate('add_order_wise_shipping')}} </h5>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="duration" class="form-control"
                                            placeholder="{{\App\CPU\Helpers::translate('Ex')}} : 4-6 {{\App\CPU\Helpers::translate('days')}}">
                                </div>

                                <div class="col-md-3">
                                    <label for="cost" class="title-color">{{\App\CPU\Helpers::translate('cost')}}</label>
                                    <input type="number" min="0" max="1000000" name="cost" class="form-control" placeholder="{{\App\CPU\Helpers::translate('Ex')}} : 10 $">
                                </div>
                            </div>
                        </div>
        ...
        <div class="card mt-2" id="update_category_shipping_cost">
            <div class="card-header text-capitalize">
                <h5 class="mb-0">{{\App\CPU\Helpers::translate('update_category_shipping_cost')}}</h5>
            </div>
            <div class="table-responsive">
...
<script>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                text: "{{\App\CPU\Helpers::translate('You wont be able to revert this!')}}",
