    ...
    <div class="content container-fluid">
        ...
        <div class="page-header pb-0 border-0 mb-3">
            <div class="flex-between row align-items-center mx-1">
                <div>
                    <h1 class="page-header-title">{{\App\CPU\Helpers::translate('Dashboard')}}</h1>
                    <div>{{ \App\CPU\Helpers::translate('Welcome_message')}}.</div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-between align-items-center g-2 mb-3">
                    <div class="col-sm-6">
                        <h4 class="d-flex align-items-center text-capitalize gap-10 mb-0">
                            ...
                            {{\App\CPU\Helpers::translate('business_analytics')}}
                        </h4>
                    </div>
                    <div class="col-sm-6 d-flex justify-content-sm-end">
                        <select class="custom-select w-auto" name="statistics_type"
                            ...
                            <option
                                ...
                                {{\App\CPU\Helpers::translate('Overall Statistics')}}
                            </option>
                            <option
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content"
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">{{\App\CPU\Helpers::translate('Withdraw Request')}}</h5>
                    ...
                    <form action="{{route('seller.withdraw.request')}}" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="recipient-name" class="col-form-label">{{\App\CPU\Helpers::translate('Amount')}}
                                    :</label>
                        ...
                        <div class="modal-footer">
                            ...
                            @if(auth('seller')->user()->account_no==null || auth('seller')->user()->bank_name==null)
                                <button type="button" class="btn btn--primary btn-primary" onclick="call_duty()">
                                    {{\App\CPU\Helpers::translate('Incomplete bank info')}}
                                </button>
                            @else
                                <button type="submit"
                                        class="btn btn--primary btn-primary">{{\App\CPU\Helpers::translate('Request')}}</button>
                            @endif
                        </div>
                    </form>
                </div>
...
@push('script_2')
    ...
    <script>
        function call_duty() {
            toastr.warning('{{\App\CPU\Helpers::translate('Update your bank info first!')}}', '{{\App\CPU\Helpers::translate('Warning')}}!', {
                CloseButton: true,
                ProgressBar: true
            });
        }
    ...
    <script>
        ...
        function business_overview_stats_update(type) {
            ...
            $.post({
                url: '{{route('seller.dashboard.business-overview')}}',
                data: {
