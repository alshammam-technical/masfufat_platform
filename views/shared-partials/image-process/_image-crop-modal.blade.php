        ...
        <div class="modal-content" style="width: {{$width+66}}px;margin-left: {{$margin_left}}">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-block alert-success" id="img-suc-{{$modal_id}}"
                    ...
                    <strong class="green">
                        {{\App\CPU\Helpers::translate('Image uploaded successfully')}}.
                    </strong>
                </div>
                ...
                <div class="alert alert-block alert-danger" id="img-err-{{$modal_id}}"
                     style="display: none;">
                    <strong class="red">
                        {{\App\CPU\Helpers::translate('Error , Something went wrong')}} !
                    </strong>
                </div>
                ...
                <form>
                    ...
                    <div class="form-group" id="select-img-{{$modal_id}}">
                        <label for="image-set-{{$modal_id}}" class="custom-file-upload">
                            {{\App\CPU\Helpers::translate('Choose Image')}} <i class="fa fa-plus-circle"></i>
                        </label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn--primary btn-primary btn-upload-image-{{$modal_id}}" style="display: none">
