...
@section('title',\App\CPU\Helpers::translate('All Brands Page'))
                                ...
                                <div class="brand_div d-flex align-items-center justify-content-center"
                                 style="height: 200px">
                                    <img
                                        ...
                                        src="{{asset("storage/app/public/brand/".(\App\CPU\Helpers::get_prop('App\Model\Brand',$brand['id'],'image',session()->get('local')) ?? $brand->image))}}"
                                        alt="{{$brand->name}}">
                                </div>
                            </a>
                        </div>
