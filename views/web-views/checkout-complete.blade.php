...
@section('title',\App\CPU\Helpers::translate('Order Complete'))
                ...
                <div class="card">
                    @if(auth('customer')->check())
                        <div class=" p-5">
                            <div class="row">
                                <div class="col-md-6">
                                    <h5 style="font-size: 20px; font-weight: 900">{{\App\CPU\Helpers::translate('your_order_has_been_placed_successfully!')}}
                                        !</h5>
                                </div>
                            </div>
