...
@section('title',\App\CPU\Helpers::translate('Contact Us'))
    ...
    <div class="container rtl">
        <div class="row">
            <div class="col-md-12 sidebar_heading text-center mb-2">
                <h1 class="h3  mb-0 folot-left headerTitle">{{\App\CPU\Helpers::translate('contact_us')}}</h1>
            </div>
        </div>
    </div>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-lg-6 for-send-message px-4 px-xl-5  box-shadow-sm">
                <h2 class="h4 mb-4 text-center"
                    style="color: #030303; font-weight:600;">{{\App\CPU\Helpers::translate('send_us_a_message')}}</h2>
                    <form action="{{route('contact.store')}}" method="POST" id="getResponse">
                        @csrf
                        <div class="row">
                          <div class="col-sm-6">
                              <div class="form-group">
                                <label >{{\App\CPU\Helpers::translate('your_name')}}</label>
                          ...
                          <div class="col-sm-6">
                              <div class="form-group">
                                <label for="cf-email">{{\App\CPU\Helpers::translate('email_address')}}</label>
                            ...
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label for="cf-phone">{{\App\CPU\Helpers::translate('your_phone')}}</label>
                                <input class="form-control mobile_number"  type="text" name="mobile_number"
                                  value="{{ old('mobile_number') }}"  placeholder="{{\App\CPU\Helpers::translate('Contact Number')}}" required>

                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-group">
                                <label for="cf-subject">{{\App\CPU\Helpers::translate('Subject')}}:</label>
                                <input class="form-control subject" type="text" name="subject"
                                  value="{{ old('subject') }}"   placeholder="{{\App\CPU\Helpers::translate('Short title')}}" required>

                              </div>
                            </div>
                             <div class="col-md-12">
                            <div class="form-group">
                              <label for="cf-message">{{\App\CPU\Helpers::translate('Message')}}</label>
                        ...
                        @if(1 == 1)
                            <div id="recaptcha_element" style="width: 100%;" data-bs-type="image"></div>
                            <br/>
                        @else
                            <div class="row p-2">
