...
@section('content')
    ...
    <div class="content container-fluid" >
        ...
        <!-- End Inlile Menu -->
        <form id="vironeer-submited-form" action="{{ route('admin.store-education.back-end.articles.update', $article->id) }}" method="POST"
                    ...
                    <div class="card-body text-{{(Session::get('direction') ?? 'rtl') === "rtl" ? 'right' : 'left'}}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="short_description" rows="6" class="form-control"
                                placeholder="{{\App\CPU\Helpers::translate('50 to 200 character at most') }}">{{ $article->short_description }}</textarea>
                        </div>
                        <div class="mb-5">
