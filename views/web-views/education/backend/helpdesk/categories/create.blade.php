...
@section('title', "{{\App\CPU\Helpers::translate('Add Category')}}")
...
@section('content')
    ...
    <div class="content container-fluid" >
            ...
            <div style="display: flex; align-items: center; width: 100%;">
                <nav aria-label="breadcrumb" style="flex-grow: 1;width: 100%;">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('admin.store-education.back-end.categories')}}">{{\App\CPU\Helpers::translate('categoriess')}}</a>
                        </li>
                        <li class="breadcrumb-item" aria-current="page">
                            <a>
                                {{\App\CPU\Helpers::translate('Edit Article')}}
                            </a>
                        </li>
                    </ol>
                </nav>
        ...
        <!-- End Inlile Menu -->
        <form id="vironeer-submited-form" action="{{ route('admin.store-education.back-end.categories.store') }}" method="POST"
            ...
            <div class="col-md-12">
                <div class="card h-100">
                    <div class="card-header">
                        <h5 class="mb-0">{{\App\CPU\Helpers::translate('Add Category')}}</h5>
                    </div>
