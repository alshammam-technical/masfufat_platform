        ...
        <div class="vr__sing__error">
            ...
            <div class="row">
                <div class="col-lg-7 m-auto">
                    <p>{{ \App\CPU\Helpers::translate(You can’t always get what you want. It’s true in life, and it’s true on the web — sometimes, what you’re looking for just isn’t there', 'error pages') }}.
                    </p>
                </div>
            </div>
            <a href="{{ url('/') }}" class="btn btn-dark"><i
                    class="fa fa-home me-1"></i>{{ \App\CPU\Helpers::translate(Back to home', 'error pages') }}</a>
        </div>
    </div>
