        ...
        <div class="row">
            <div class="col-lg-6 m-auto">
                <div class="empty text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="mb-3" data-name="Layer 1" width="300"
                        height="200" viewBox="0 0 788.6063 505.46457" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <path
                    ...
                    <h3>{{ \App\CPU\Helpers::translate(No Results Found', 'user') }}</h3>
                    <p>{{ \App\CPU\Helpers::translate(It looks like this section is empty or your search did not return any results, you can start creating a content or search using another word', 'user') }}.
                    </p>
                </div>
            </div>
        </div>
