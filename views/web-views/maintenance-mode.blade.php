...
<head>
    <meta charset="utf-8">
    <title>
        {{\App\CPU\Helpers::translate('Maintenance Mode on')}}
    </title>
    ...
    <div class="row">
        <div class="col-12 mt-5">
            <center>
                ...
                <h1>{{\App\CPU\Helpers::translate('Website is under Maintenance')}}.</h1><br>
                <h5>{{\App\CPU\Helpers::translate('Plese come back later')}}.</h5>
            </center>
        </div>
    </div>
</div>
