        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ \App\CPU\Helpers::translate('Order No')}} - {{$orderDetails['id']}}</h5>
                ...
                <div class="modal-body pb-0">
                    ...
                    @php($current_lang = session('lang') ?? 'sa')
                    @foreach($order as $product)
                        ...
                        <div class="d-sm-flex justify-content-between mb-4 pb-3 pb-sm-2 border-bottom">
                                ...
                                <a class="d-inline-block mx-auto mr-sm-4"
                                   href="{{route('product',$productDetails->slug)}}" style="width: 10rem;">
                                    <img
                                        ...
                                        src="{{asset("storage/app/public/product/$current_lang")}}/{{(isset(json_decode($productDetails['images'])->$current_lang)) ? json_decode($productDetails['images'])->$current_lang[0] ?? '' : ''}}">
                                </a>
                            ...
                            <div class="pt-2 pl-sm-3 mx-auto mx-sm-0 text-center">
                                <div class="text-muted mb-2">{{ \App\CPU\Helpers::translate('Quantity')}}:</div>{{$product['qty']}}
                            </div>
                            <div class="pt-2 pl-sm-2 mx-auto mx-sm-0 text-center">
                                <div class="text-muted mb-2">{{ \App\CPU\Helpers::translate('Tax')}}:
                                </div>{{\App\CPU\Helpers::currency_converter($product['tax'])}}
                            </div>
                            <div class="pt-2 pl-sm-3 mx-auto mx-sm-0 text-center">
                                <div class="text-muted mb-2">{{ \App\CPU\Helpers::translate('Subtotal')}}</div>{{\App\CPU\Helpers::currency_converter($product['price']*$product['qty'])}}
                            </div>
                        </div>
                ...
                <div class="modal-footer flex-wrap justify-content-between bg-secondary font-size-md">
                        ...
                        <div class="px-2 py-1">
                            <span
                                class="text-muted">{{ \App\CPU\Helpers::translate('Subtotal')}}:&nbsp;</span>{{\App\CPU\Helpers::currency_converter($sub_total)}}
                            <span></span>
                        </div>
                        <div class="px-2 py-1">
                            <span
                                class="text-muted">{{ \App\CPU\Helpers::translate('Shipping')}}:&nbsp;</span>{{\App\CPU\Helpers::currency_converter($total_shipping_cost)}}
                            <span></span>
                        </div>
                        <div class="px-2 py-1">
                            <span class="text-muted">{{ \App\CPU\Helpers::translate('Tax')}}:&nbsp;</span> {{\App\CPU\Helpers::currency_converter($total_tax)}}
                            <span></span>
                        </div>

                        <div class="px-2 py-1">
                            <span
                                class="text-muted">{{ \App\CPU\Helpers::translate('Discount')}}:&nbsp;</span>
                ...
                <div class="modal-footer flex-wrap justify-content-between bg-secondary font-size-md">
                    <div class="px-2 py-1">
                        <span
                            class="text-muted">{{ \App\CPU\Helpers::translate('Coupon Discount')}}:&nbsp;</span>
                    ...
                    <div class="px-2 py-1">
                        <span
                            class="text-muted">{{ \App\CPU\Helpers::translate('Extra Discount')}}:&nbsp;</span>
                        - {{\App\CPU\Helpers::currency_converter($extra_discount)}}
                        <span></span>
                    </div>
                    @endif
                    <div class="px-2 py-1">
                        <span class="text-muted">{{ \App\CPU\Helpers::translate('Total')}}:&nbsp; </span>
        ...
        <div class="bg-primaryColor">
            <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
                ...
                <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
                    <h4 class="text-light mb-0">{{ \App\CPU\Helpers::translate('Order ID')}} : <span
    ...
    <div class="container mb-md-3">
        ...
        <div class="row" style="background: #e2f0ff; margin: 0; width: 100%;">
            <div class="col-sm-4">
                <div class="pt-2 pb-2 text-center rounded-lg">
                    <span class="font-weight-medium text-dark mr-2">{{ \App\CPU\Helpers::translate('Order Status')}}:</span><br>
            ...
            <div class="col-sm-4">
                <div class="pt-2 pb-2 text-center rounded-lg">
                    <span class="font-weight-medium text-dark mr-2">{{ \App\CPU\Helpers::translate('Payment Status')}}:</span> <br>
                    <span class="text-uppercase">{{$orderDetails['payment_status']}}</span>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="pt-2 pb-2 text-center rounded-lg">
                    <span class="font-weight-medium text-dark mr-2"> {{ \App\CPU\Helpers::translate('Estimated Delivary Date')}}: </span> <br>
                    <span class="text-uppercase"
        ...
        <div class="card border-0 box-shadow-lg mt-5">
            <div class="card-body pb-2">
                <ul class="nav nav-tabs lightSlider media-tabs nav-justified">
                            ...
                            <div class="nav-link">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body" style="text-align: center;">
                                        <div class="media-tab-subtitle text-muted font-size-xs mb-1">{{ \App\CPU\Helpers::translate('First step')}}</div>
                                        <h6 class="media-tab-title text-nowrap mb-0">{{ \App\CPU\Helpers::translate('Order placed')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nav-item ">
                            <div class="nav-link ">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body" style="text-align: center;">
                                        <div class="media-tab-subtitle text-muted font-size-xs mb-1">{{ \App\CPU\Helpers::translate('Second step')}}</div>
                                        <h6 class="media-tab-title text-nowrap mb-0">{{ \App\CPU\Helpers::translate('Packaging order')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <div class="nav-link  ">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body" style="text-align: center;">
                                        <div class="media-tab-subtitle text-muted font-size-xs mb-1">{{ \App\CPU\Helpers::translate('Third step')}}</div>
                                        <h6 class="media-tab-title text-nowrap mb-0">{{ \App\CPU\Helpers::translate('Preparing Shipment')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="nav-item">
                            <div class="nav-link ">
                                <div class="align-items-center">
                                    ...
                                    <div class="media-body" style="text-align: center;">
                                        <div class="media-tab-subtitle text-muted font-size-xs mb-1">{{ \App\CPU\Helpers::translate('Fourth step')}}</div>
                                        <h6 class="media-tab-title text-nowrap mb-0">{{ \App\CPU\Helpers::translate('Order Shipped')}}</h6>
                                    </div>
                                </div>
                            </div>
                        </li>
                    @elseif($orderDetails['order_status']=='returned')
                        <li class="nav-item">
                            <div class="nav-link" style="text-align: center;">
                                <h1 class="text-warning">{{ \App\CPU\Helpers::translate('Product Successfully Returned')}}</h1>
                            </div>
                        </li>
                    @else
                        <li class="nav-item">
                            <div class="nav-link" style="text-align: center;">
                                <h1 class="text-danger">{{ \App\CPU\Helpers::translate("Sorry we can`t complete your order")}}</h1>
                            </div>
                        </li>
                    @endif
