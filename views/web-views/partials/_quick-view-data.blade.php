            ...
            <div class="details" style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                ...
                @if($product->discount > 0)
                    <div class="flex-start mb-3">
                        <div><strong>{{\App\CPU\Helpers::translate('discount')}} : </strong></div>
                        <div><strong id="set-discount-amount" class="mx-2"></strong></div>
                    </div>
                @endif

                <div class="flex-start mb-3">
                    <div><strong>{{\App\CPU\Helpers::translate('tax')}} : </strong></div>
                ...
                <!-- Quantity + Add to cart -->
                    <div class="row no-gutters">
                        <div class="col-2">
                            <div class="product-description-label mt-2">{{\App\CPU\Helpers::translate('Quantity')}}:</div>
                        </div>
                        <div class="col-10">
                            <div class="product-quantity d-flex align-items-center">
                                <div class="input-group input-group--style-2 pr-3"
                                    ...
                                    <span class="input-group-btn">
                                        <button class="btn btn-number" product-type="{{ $product->product_type }}" type="button" data-bs-type="plus"
                                                data-bs-field="quantity" style="padding: 10px">
                                           +
                                        </button>
                                    </span>
                                </div>
                    ...
                    <div class="row no-gutters d-none mt-2" id="chosen_price_div">
                        ...
                        <div class="col-12">
                            @if(($product['product_type'] == 'physical') && ($product['current_stock']<=0))
                                <h5 class="mt-3" style="color: red">{{\App\CPU\Helpers::translate('out_of_stock')}}</h5>
                            @endif
                        </div>
                    </div>
                    {{--to do--}}
                    <div class="d-flex justify-content-between mt-2">
                        ...
                        <button class="btn btn--primary string-limit"
                                ...
                                type="button"
                                style="width:37%; height: 45px">
                            {{\App\CPU\Helpers::translate('add_to_cart')}}
                        </button>
