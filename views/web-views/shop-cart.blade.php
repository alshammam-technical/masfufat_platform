...
@section('title',\App\CPU\Helpers::translate('My Shopping Cart'))
...
@section('content')
    <div class="container pb-5 mb-2 sm:mt-3 rtl" style="text-align: {{(Session::get('direction') ?? 'rtl') === "rtl" ? 'right' : 'left'}};" id="cart-summary">
