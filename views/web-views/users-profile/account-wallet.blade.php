...
@section('title',\App\CPU\Helpers::translate('My Wallet History'))
            ...
            <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                        <li class="breadcrumb-item"><a class="text-nowrap" href="{{route('home')}}"><i class="czi-home"></i>{{\App\CPU\Helpers::translate('Home')}}</a></li>
                        <li class="breadcrumb-item text-nowrap"><a href="#">{{\App\CPU\Helpers::translate('Account')}}</a>
                        </li>
                        <li class="breadcrumb-item text-nowrap active" aria-current="page">{{\App\CPU\Helpers::translate('Wallet history')}}</li>
                    </ol>
                </nav>
            </div>
            ...
            <section class="col-lg-12">
                ...
                <div class="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
                    <div class="form-inline">
                        ...
                        <select class="form-control custom-select" id="order-sort">
                            ...
                            <option>{{\App\CPU\Helpers::translate('In Progress')}}</option>
                ...
                <div class="table-responsive font-size-md">
                        <table class="table table-hover mb-0">
                            <thead>
                            <tr>
                                <th>{{\App\CPU\Helpers::translate('Trans ID')}}#</th>
                                <th>{{\App\CPU\Helpers::translate('Transaction Method')}}</th>
                                <th>{{\App\CPU\Helpers::translate('Transaction_type')}} </th>
                                <th>{{\App\CPU\Helpers::translate('Transaction Amount')}}</th>
                            </tr>
                            </thead>
                            <tbody>
                ...
                <nav class="d-flex justify-content-between pt-2" aria-label="Page navigation">
                    ...
                    <ul class="pagination">
                        ...
                        <li class="page-item active d-none d-sm-block" aria-current="page"><span class="page-link">1<span class="sr-only">({{\App\CPU\Helpers::translate('current')}})</span></span></li>
