...
@section('title')
{{ Request::is('chat/seller') ? \App\CPU\Helpers::translate('chat_with_seller') : \App\CPU\Helpers::translate('chat_with_delivery-man')}}
@endsection
...
@push('css_or_js')
    <style>
        ...
        .received_withd_msg {
            background: #EFE8FF none repeat scroll 0 0;
            border-radius: 10px;
            color: #030303;
            font-size: 14px;
            margin: 0;
        ...
        .incoming_msg_img img , .outgoing_msg_img img {
            width: 50px;
            border-radius: 10px;
        }
                                    ...
                                    @foreach($unique_shops as $key=>$shop)
                                        <div class="chat_list chat_list_ @if ($key == 0) bg-white @endif"
                                            ...
                                            <div class="chat_people d-flex">
                                                ...
                                                <div class="chat_ib">
                                                    <h5 class="mt-1 seller @if($shop->seen_by_customer)active-text @endif"
                                ...
                                <div class="mesgs bg-light px-0 h-full">
                                                    ...
                                                    <div class="incoming_msg">
                                                        ...
                                                        <div class="received_msg">
                                                            <div class="received_withd_msg">
                                                                ...
                                                                <span class="time_date"> {{$chat->created_at->format('h:i A')}}    |    {{$chat->created_at->format('Y/m/d')}} </span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                @else
                                                    ...
                                                    <div class="outgoing_msg">
                                                        ...
                                                        <div class="outgoing_msg_img">
                                                            <img src="{{asset('storage/app/public/company')}}/{{$web_config['fav_icon']->value}}" alt="sunil">
                                                        </div>
                                                    </div>
                                                @endif
                                            @endForeach
                                    ...
                                    <div class="type_msg bg-white">
                                        <div class="input_msg_write">
                                            <form
                                                class="d-flex md-form form-sm active-cyan-2 mt-2 mx-3"
                                                id="myForm">
                                                @csrf
