...
@section('title',\App\CPU\Helpers::translate('Refund Details'))
    ...
    @php($current_lang = session('local'))
        <section class="col-lg-12 col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-6 col-md-6 text-left">
                                    ...
                                    <span >{{\App\CPU\Helpers::translate('QTY')}} : {{$refund->order_details->qty}}</span><br>
                                    <span>{{\App\CPU\Helpers::translate('price')}} : {{\App\CPU\Helpers::currency_converter($refund->order_details->price)}}</span><br>
                                    @if ($order_details->variant!=null)
                                        <span>{{\App\CPU\Helpers::translate('variant')}} : </span>
                                    ...
                                    <div class="row justify-content-md-end mb-3">
                                        <div class="col-md-10 col-lg-10">
                                            <dl class="row text-sm-right">
                                                <dt class="col-sm-7">{{\App\CPU\Helpers::translate('total_price')}} : </dt>
                                                <dd class="col-sm-5 ">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="row text-center">
                                <span class="col-sm-2">{{\App\CPU\Helpers::translate('subtotal')}} : {{\App\CPU\Helpers::currency_converter($subtotal)}}</span>
                                <span class="col-sm-5">{{\App\CPU\Helpers::translate('coupon_discount')}} : {{\App\CPU\Helpers::currency_converter($coupon_discount)}}</span>
                                <span class="col-sm-5">{{\App\CPU\Helpers::translate('total_refund_amount')}} : {{\App\CPU\Helpers::currency_converter($refund_amount)}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="col-12">
                                <b>{{\App\CPU\Helpers::translate('refund_id')}}</b> :
                                <span>{{$refund->id}}</span>
                            </div>
                            <div class="col-12">
                                <b>{{\App\CPU\Helpers::translate('refund_status')}}</b> :
                            ...
                            <div class="col-12">
                               <span><b>{{\App\CPU\Helpers::translate('rejected_reason')}}</b> : </span> {{$refund->rejected_note}}
                            </div>
                            @endif
                            @if ($refund->status == 'refunded')
                            <div class="col-12">
                               <span><b>{{\App\CPU\Helpers::translate('payment_info')}}</b> : </span> {{$refund->payment_info}}
                            </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div style="overflow: auto">
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-6">
                                            <h5>{{\App\CPU\Helpers::translate('refund_reason')}}</h5>
                                        </div>
            ...
            <div class="row">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5>{{\App\CPU\Helpers::translate('attachment')}}</h5>
                    </div>
                    <div class="row">
                        <div class="card-body">
                            @if ($refund->images !=null)
                                <div class="gallery">
                                    @foreach (json_decode($refund->images) as $key => $photo)
                                        <a href="{{asset('storage/app/public/refund')}}/{{$photo}}" data-bs-lightbox="mygallery">
