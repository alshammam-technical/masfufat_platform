...
@section('title',\App\CPU\Helpers::translate('Refund request'))
...
<div class="container pb-5 mb-2 mb-md-4 mt-3 rtl"
    ...
    @php($current_lang = session()->get('local'))
        <section class="col-lg-12 mt-2 col-md-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-9 col-sm-7 text-left">
                                    <p>{{Helpers::getItemName('products','name',$product->id)}}</p>
                                ...
                                <div class="col-4 col-sm-3 text-left d-flex flex-column pl-0 mt-2 mt-sm-0 pl-sm-5">
                                    <span >{{\App\CPU\Helpers::translate('QTY')}} : {{$order_details->qty}}</span>
                                    <span>{{\App\CPU\Helpers::translate('price')}} : {{\App\CPU\Helpers::currency_converter($order_details->price)}}</span>
                                    <span>{{\App\CPU\Helpers::translate('discount')}} : {{\App\CPU\Helpers::currency_converter($order_details->discount)}}</span>
                                    <span>{{\App\CPU\Helpers::translate('tax')}} : {{\App\CPU\Helpers::currency_converter($order_details->tax)}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="row text-center">
                                ...
                                <span class="col-sm-5">{{\App\CPU\Helpers::translate('total_refundable_amount')}}:{{\App\CPU\Helpers::currency_converter($refund_amount)}}</span>
                            </div>
                        </div>
                    </div>
                    <div class="card mt-2">
                                ...
                                <form action="{{route('refund-store')}}"  method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="input-label" for="name">{{\App\CPU\Helpers::translate('refund_reason')}}</label>
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">{{\App\CPU\Helpers::translate('attachment')}}</label>
